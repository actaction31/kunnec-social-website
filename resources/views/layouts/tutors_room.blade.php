...
<body>
    ...
    <!-- Tutor Room Exit Modal -->
    <div class="modal fade" id="tutor_roomModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-success btn-sm" type="button"><a href="{{ url('k_screen/tutors/tutors_details') }}" target="_self">Yes</a></button>
    ...
    <div class="modal fade" id="quizModal" tabindex="-1" role="dialog" aria-labelledby="quizModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="col">
                <img src="{{ asset('public/images/K_Logo5.png') }}" height="40px" width="60px"/>
                <h4 class="modal-title" id="quizModalLabel" style="color: #009900">Multiple Coice Quiz</h4><br>
                </div>
                <h3 class="card-title mt-2 ml-3"><img src="{{ asset('public/user-dash/images/users/profiles/20.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image"><font color="#009900" style="font-size:18px"> Sabrina Class</font></h3>
                    </div>
                <div class="modal-body">
                    <div id="quiz"></div>
