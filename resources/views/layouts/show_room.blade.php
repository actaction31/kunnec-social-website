...
<body>
    ...
    <!-- Show Room Exit Modal -->
    <div class="modal fade" id="show_roomModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <img src="{{ asset('public/images/K_Logo5.png') }}" height="40px" width="60px"/>
                    <h4 class="modal-title" id="exampleModalLabel" style="color: #000000">Are you sure you want to exit the show?</h4>
                ...
                <div class="modal-footer">
                    <button class="btn btn-success btn-sm" type="button"><a href="{{ url('k_live/live_details') }}" target="_self">Yes</a></button>
