...
<div class="card">
    <div class="card-body">
        ...
        <ul class="nav nav-tabs" id="2uTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="setup-tab" data-toggle="tab" href="#tab-setup" role="tab" aria-controls="tab-setup" aria-selected="true">To You Setup</a></li>
            <li class="nav-item"><a class="nav-link" id="whistory-tab" data-toggle="tab" href="#tab-whistory" role="tab" aria-controls="tab-whistory" aria-selected="false">My Work History</a></li>
            <li class="nav-item"><a class="nav-link" id="portfolio-tab" data-toggle="tab" href="#tab-portfolio" role="tab" aria-controls="tab-portfolio" aria-selected="false">My Portfolio</a></li>
            <li class="nav-item"><a class="nav-link" id="favorites-tab" data-toggle="tab" href="#tab-favorites" role="tab" aria-controls="tab-favorites" aria-selected="true">Favorites</a></li>
        ...
        <div class="tab-content border-x border-bottom p-3" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-setup" role="tabpanel" aria-labelledby="setup-tab">
                                        ...
                                        <form>
                                            <div class="row">
					                            ...
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <hr>
                                                        <input type="email" class="form-control" id="k2uEmail" aria-describedby="emailHelp" placeholder="Email">
                                                        <small id="emailHelp" class="form-text text-success ">Leave email empty if you don't want shown.</small>
                                                    </div>
                                                </div>
                                                
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <input type='text' id='yourphone' placeholder="Phone Number"/>
                                                        <small id="emailHelp" class="form-text text-success ">Leave phone number empty if you don't want shown.</small>
                                                    </div>
                                                    <hr>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control" id="intro" name="intro" cols="30" rows="13" placeholder="Type about me section ..."></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEdu1">Education # 1</label>
                                                        <div class="row">
                                                            <div class="col-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEdu1">Education # 2</label>
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <input type="text" class="form-control" placeholder="Name of School">
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEdu1">Education # 3</label>
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <input type="text" class="form-control" placeholder="Name of School">
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEdu1">Certification # 1</label>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <input type="text" class="form-control" placeholder="Title of Certification">
                                                            </div>
                                                            <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputEdu1">Certification # 2</label>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <input type="text" class="form-control" placeholder="Title of Certification">
                                                            </div>
                                        ...
                                        <div class="card mb-3 overflow-hidden">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group col-sm">
                                                        <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                            <option value="" disabled selected>Select Language 1 ...</option>
                                                            <option value="Afrikanns">Afrikanns</option>
                                                            <option value="Albanian">Albanian</option>
                                                            <option value="Albanian">Amharic</option>
                                                            <option value="Arabic">Arabic</option>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group col-sm">
                                                            <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                            <option value="" disabled selected>Select Language 2 ...</option>
                                                            <option value="Afrikanns">Afrikanns</option>
                                                            <option value="Albanian">Albanian</option>
                                                            <option value="Albanian">Amharic</option>
                                                            <option value="Arabic">Arabic</option>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group col-sm">
                                                        <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                            <option value="" disabled selected>Select Language 3 ...</option>
                                                            <option value="Afrikanns">Afrikanns</option>
                                                            <option value="Albanian">Albanian</option>
                                                            <option value="Albanian">Amharic</option>
                                                            <option value="Arabic">Arabic</option>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group col-sm">
                                                        <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                            <option value="" disabled selected>Select Language 4 ...</option>
                                                            <option value="Afrikanns">Afrikanns</option>
                                                            <option value="Albanian">Albanian</option>
                                                            <option value="Albanian">Amharic</option>
                                                            <option value="Arabic">Arabic</option>
                                                        ...
                                                        <div class="card-body bg-light">
                                                            <form>
                                                                <div class="input-group mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Your Website">
                                                                </div>
                                                                <div class="input-group mb-2">
                                                                    <div class="input-group-prepend">
                                                                ...
                                                                <div class="input-group mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Twitter">
                                                                </div>
                                                                <div class="input-group mb-2">
                                                                    <div class="input-group-prepend">
                                                                        <div class="input-group-text"><i class="fab fa-pinterest-square"></i></div>
                                                                    </div>
                                                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Pinterest">
                                                                </div>
                                                                <div class="input-group mb-2">
                                                                    <div class="input-group-prepend">
                                                                        <div class="input-group-text"><i class="fab fa-youtube"></i></div>
                                                                    </div>
                                                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Youtube">
                                                                </div>
                                                                <div class="input-group mb-2">
                                                                    <div class="input-group-prepend">
                                                    ...
                                                    <div class="card mb-3">
                                                        ...
                                                        <div class="card-body bg-light">
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">One Time </label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">Full Time</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">Part Time</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">Remote</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">Internship</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group form-check-inline">
                                                                <div class="col-sm-12">
                                                                    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                                                    <label class="form-check-label" for="defaultcheckbox1" style="color: #808080">Freelance</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <select class="form-control" id="exampleFormControlSelect1">
                                                                    <option value="" disabled selected>Hours Available ...</option>
                                                ...
                                                <div class="col-sm">
                                                    <div class="card mb-3">
                                                        ...
                                                        <div class="card-body bg-light">
                                                            ...
                                                            <div class="form-group">
                                                                <input class="form-control" id="require_2" type="text" placeholder="Type Hourly Fee here ...">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" id="require_2" type="text" placeholder="Type Salary Fee here ...">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="tab-pane fade" id="tab-whistory" role="tabpanel" aria-labelledby="whistory-tab">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="form-group">
                                <label for="inputEdu1">Job # 1</label>
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" placeholder="Job Title">
                                    </div>
                                    <div class="col-3">
                                        <input type="text" class="form-control" placeholder="(start) Month & Year">
                                    </div>
                                    <div class="col-3">
                                        <input type="text" class="form-control" placeholder="(end) Month & Year">
                                    </div>
                                    <div class="col-12 mt-2">
                                        <div class="form-group">
                                            <textarea class="form-control" id="intro" name="intro" cols="30" rows="3" placeholder="Type a brief description ..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <hr>
                                <label for="inputEdu1">Job # 2</label>
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" placeholder="Job Title">
                                    </div>
                            ...
                            <div class="form-group">
                                <hr>
                                <label for="inputEdu1">Job # 3</label>
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" placeholder="Job Title">
                                    </div>
                            ...
                            <div class="form-group">
                                <hr>
                                <label for="inputEdu1">Job # 4</label>
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" placeholder="Job Title">
                                    </div>
                            ...
                            <div class="form-group">
                                <hr>
                                <label for="inputEdu1">Job # 5</label>
                                <div class="row">
                                    <div class="col-6">
                                        <input type="text" class="form-control" placeholder="Job Title">
                                    </div>
            ...
            <div class="tab-pane fade" id="tab-portfolio" role="tabpanel" aria-labelledby="portifolio-tab">
                <div id="accordion">
                    <div class="card-header1">
                        ...
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapseMusic" aria-expanded="true" aria-controls="collapseMusic" style="color: #009900;">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12 col-md-12">
                                                <div class="control-group" id="fields">
                                                    ...
                                                    <button class="btn1 btn-kunnec">Upload</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="card-header" id="headingVideos">
                            <h5 class="mb-0">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseVideos" aria-expanded="false" aria-controls="collapseVideos" style="color: #009900;">
                        ...
                        <div class="card-header" id="headingImages">
                            <h5 class="mb-0">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseImages" aria-expanded="false" aria-controls="collapseImages" style="color: #009900;"> Images (  Photos, Art, Design and Projects )
                                    </button>
                                </div>
                            </h5>
                        </div>
            ...
            <div class="tab-pane fade" id="tab-favorites" role="tabpanel" aria-labelledby="favorites-tab">
                <div class="card">
