        ...
        <div class="row no-gutters">
            ...
            <div class="col-12 text-center w-100">
                <div class="grid form-row gallery text-center">
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item producer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/sabrina.jpg')}}" alt="..." />
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item decor engineer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/1.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item singer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/21.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item producer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/15.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item singer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/11.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 grid-item rapper">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/9.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-lg-0 grid-item engineer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/7.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                                        <h4>Minimalistic Style Appartment</h4>
                                        <p>[Engineer]</p>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-sm-0 grid-item rapper">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/16.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 grid-item singer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-lg-0 grid-item producer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/4.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-sm-0 grid-item rapper">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/14.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 grid-item singer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/23.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-lg-0 grid-item engineer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/2.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-2 mb-sm-0 grid-item rapper">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/13.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
                    ...
                    <div class="col-lg-4 col-sm-6 grid-item singer">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-image">
                                <img src="{{ asset('public/user-dash/images/users/profiles/22.jpg')}}" alt="..." />
                            </div>
                            <a href="{{ url('k_you/k2u_profile') }}">
                                <div class="portfolio-overlay">
                                    <div class="portfolio-content">
