...
<div class="card">
    <div class="card-header d-flex justify-content-between" style="background-color:#009900;">
        <a href="{{ url('events/event_home') }}" style="color: #FFFFFF">
            <h5 class="mb-0" style="color:#FFFFFF;"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40" width="60"/> Event Search</h5>
        </a>
        ...
        <div class="media text-muted pt-3">
            <div class="media btn-reveal-trigger">
                ...
                <div class="media-body position-relative pl-3">
                    ...
                    <p class="text-1000 mb-0">Location: Las Vegas, NV</p>
                    <p class="text-1000 mb-0">Date: Feb 29 - Mar 2</p>
                    <button type="button" class="btn btn-primary btn-sm" style="border-radius:16px;">
                        <i class="fas fa-dollar-sign"></i> 5.00 &nbsp;&nbsp;
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="media text-muted pt-3">
        ...
        <div class="calendar"><span class="calendar-month">Dec</span><span class="calendar-day">16</span></div>
            <div class="media-body position-relative pl-3">
                ...
                Place: Porter Square, North Cambridge
                <p class="text-1000 mb-0">Location: Las Vegas, NV</p>
                <p class="text-1000 mb-0">Date: Mar 25</p>
                <button type="button" class="btn btn-primary btn-sm" style="border-radius:16px;">
                    <i class="fas fa-dollar-sign"></i> 25.00 &nbsp;&nbsp;
                </button>
            </div>
        </div>
    </div>
