...
<div class="card">
    <div class="card-header" style="background-color:#009900; color: #FFFFFF; font-size:20px;">
        <span class="fab fa-apple"></span> Mac OS Setup
    </div>
    <div class="card-body">
        <div class="alert alert-warning">
            <strong>Operating System:</strong> Catalina 10.15.7 - Ventura 13.1.0 &nbsp;&nbsp;<strong>Processor:</strong> M1 or Intel Core 2 Duo Processor (i5 or faster recommended) &nbsp;&nbsp;<strong>Memory</strong>  16GB RAM
        </div>
