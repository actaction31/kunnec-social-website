    ...
    <div class="row">
		<div class="col-sm mt-2">
            ...
            <a href="{{ url('k_screen/recording/record') }}" style="color: #FFFFFF"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Screen
                </a> |&nbsp;<a href="{{ url('k_screen/recording/record_settings') }}" style="font-size:20px; color: #ffffff;">
				...
				<div class="media">
				    <div class="row">
                        ...
                        <div class="col-sm">
						    ...
						    <button class="btn btn-warning mr-5 mb-1" type="button"><a href="{{ url('k_screen/recording/record_list') }}">Filter</a></button>
				        </div>
				    </div>
			    </div>
            </div>
                ...
                <div class="p-1">
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="position-relative h-sm-50"><a class="d-block h-50" href="{{ url('k_screen/recording/record_details') }}"><img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/recordings/2.jpg') }}" alt="" /></a>
                            </div>
                        </div>
						<div class="col-sm-7 col-md-8">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_screen/recording/record_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                    ...
                                    <ul class="list-unstyled d-none d-lg-block">
                                        ...
                                        <li>
                                            <button class="btn btn-warning rounded-capsule mr-1 mb-1" type="button" href="#!">
					            ...
					            <div class="col-lg-4 d-flex justify-content-between flex-column">
						            ...
						            <div class="mt-md-2">
                                        <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Save Recorder</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_screen/recording/record_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Recorder Details</font></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="p-1">
                    ...
                    <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100">
                            <div class="item h-100">
                                <a class="d-block h-sm-100" href="{{ url('k_screen/recording/record_details') }}"><img class="rounded h-100 w-100 fit-cover" src="{{ asset('public/user-dash/k_screen/recordings/3.jpg') }}" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <ul class="list-unstyled d-none d-lg-block">
							        ...
							        <li>
                                        <button class="btn btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#recordModal">
                          ...
                          <div class="col-lg-4 d-flex justify-content-between flex-column">
                            ...
                            <div class="mt-md-2"><a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Save Recorder</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_screen/recording/record_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Record Details</font></span></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-12 p-3">
                  <div class="p-1">
                    <div class="row">
                      <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100"><a class="d-block h-100" href="{{ url('k_screen/recording/record_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/recordings/5.jpg') }}" alt="" /></a>
                        </div>
                      </div>
                      <div class="col-sm-7 col-md-8">
                        <div class="row">
                          <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_screen/recording/record_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                            <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Recorder: </small><img src="{{ asset('public/user-dash/images/users/profiles/22.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Shaheed</p>
                            <ul class="list-unstyled d-none d-lg-block">
                              <li><span><font style="color: #3f3f3f;">Schedule:</font></span>  <span><font style="color: #3f3f3f;">T ( 7 - 9 am ), Th ( 10 - 12 am ) </font></span></li>
                              
                              <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                              <li>
                                    <button class="btn btn-danger rounded-capsule mr-1 mb-1" type="button" href="#!"><span class="fas fa-ban"></span> Recording in Session
                                    </button>
                                </li>
                            </ul>
                          </div>
                          <div class="col-lg-4 d-flex justify-content-between flex-column">
                            ...
                            <div class="mt-md-2"><a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Save Recorder</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_screen/recording/record_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Recorder Details</font></span></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-12 p-3 bg-100">
                  <div class="p-1">
                    <div class="row">
                      <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100"><a class="d-block h-100" href="{{ url('k_screen/recording/record_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/recordings/4.jpg') }}" alt="" /></a>
                        </div>
                      </div>
                      <div class="col-sm-7 col-md-8">
                        <div class="row">
                          <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_screen/recording/record_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                            <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Recorder: </small><img src="{{ asset('public/user-dash/images/users/profiles/20.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Michael</p>
                            <ul class="list-unstyled d-none d-lg-block">
