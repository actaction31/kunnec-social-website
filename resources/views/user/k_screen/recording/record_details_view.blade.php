@extends('layouts.user')
 @section('title', 'Screen Details View')
        ...
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50"><a class="d-block h-50"><img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/recordings/2.jpg') }}" alt="" /></a>
                ...
                <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" >
                    <a href="{{ url('k_screen/recording/record_settings') }}" style="color: #FFFFFF;"><span class="fas fa-edit"></span> Back to Screen Details Setup </a>
                </button>
