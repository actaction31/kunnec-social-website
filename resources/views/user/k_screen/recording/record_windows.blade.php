...
<div class="card">
    <div class="card-header" style="background-color:#009900; color: #FFFFFF; font-size:20px;">
        <span class="fab fa-windows"></span>  Windows Setup
    </div>
    <div class="card-body">
        <div class="alert alert-warning">
            <strong>Operating System:</strong> Windows 10, 11 &nbsp;&nbsp;<strong>Processor:</strong> 64-bit Intel Core Processor (i3/2 Ghz or faster recommended) &nbsp;&nbsp;<strong>Memory</strong>  8GB RAM
        </div>
	</div>	
</div>
@endsection
