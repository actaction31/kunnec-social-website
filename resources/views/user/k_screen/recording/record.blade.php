...
<div class="col-lg-12 rounded mb-2" style="background-color:#009900;">
    <div class="row">
		<div class="col-sm mt-2">
            ...
            <a href="{{ url('k_screen/recording/record') }}" style="color: #FFFFFF"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Record
                </a> |&nbsp;
...
<div class="card">
    ...
    <img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/2.jpg') }}" alt="Card image cap">
    <div class="card-body">
        <h6 class="fs-9">
            <strong>
                <a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp
                </a>
            </strong>
        </h6>
        <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Category: Music-Rock</a></p>
        ...
        <p class="fs--1 mb-1">Credits per 15 mins.: <strong class="text-danger">96</strong></p>
	</div>                                          
	<div class="d-flex align-items-center justify-content-between px-3">
        ...
        <div>
            <a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Save Recorder">
	...
	<div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/1.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!"> Category: Tutoring</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
            ...
            <p class="fs--1 mb-1">Credits per hr.: <strong class="text-danger">125</strong></p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
            ...
            <div><a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Save Recorder"><span class="far fa-heart"></span></a>
			</div>
        </div>
    </div>
	
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/5.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Category: Tutoring</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
            ...
            <p class="fs--1 mb-1">Credits per mins.: <strong class="text-danger">65</strong></p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/6.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Photoshop CS4 training</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Category: R&B</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
            ...
            <p class="fs--1 mb-1">Credits FLAT-FEE: <strong class="text-danger">46</strong></p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
...
<div>
    <p class=" text-center" style="color: #FFFFFF"><strong>Top Rated Recorders</p>
</div>  
<div>
...
<div class="card-deck">
    <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/7.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
	...
	<div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/8.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/9.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/recordings/3.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/recording/record_details') }}" style="font-size: 1.0rem; color: #009900;">Photoshop CS4 training</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
