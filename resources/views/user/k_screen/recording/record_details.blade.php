        ...
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50">
                        <a class="d-block h-50" href="{{ url('k_screen/recording/record_details') }}">
                            <img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/recordings/2.jpg') }}" alt="" />
                        </a>  
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#recordModal">
                    <span class="fas fa-handshake"></span> Enter Recording Session
                </button>
                <button class="btn btn-lg btn-danger rounded-capsule mr-1 mb-1" type="button" href="#!">
                    <span class="fas fa-ban"></span> Recording in Session
                </button>
                <button class="btn btn-lg btn-warning rounded-capsule mr-1 mb-1" type="button" href="#!">
            ...
            <div class="row">
                ...
                <div class="col-sm-auto pl-3 pl-sm-0">
                    <a class="btn btn-sm btn-outline-danger border-300 mr-2 mt-2 mt-sm-0" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Recorder List"><span class="far fa-heart mr-1"></span>282</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="fancy-tab overflow-hidden mt-4">
                ...
                <div class="tab-contents">
                    <div class="tab-content active">
                        <p>Over the years, Apple has built a reputation for releasing its products with a lot of fanfare â€“ but that didnâ€™t exactly happen for the MacBook Pro 2018. Rather, Appleâ€™s latest pro laptop experienced a subdued launch, in spite of it offering a notable spec upgrade over the 2017 model â€“ along with an improved keyboard. And, as with previous generations the 15-inch MacBook Pro arrives alongside a 13-inch model.
                        </p>
                        ...
                        <p>Still, Apple wants mainstream users to buy the MacBook Pro, too. So, if youâ€™re just looking for the most powerful MacBook on the market, youâ€™ll love this new MacBook Pro. Just keep in mind that, while the keyboard has been updated, there are still some issues with it.
                        </p>
                        <p>Thereâ€™s enough of a difference between the two sizes when it comes to performance to warrant two separate reviews, and here weâ€™ll be looking at how the flagship 15-inch MacBook Pro performs in 2019.
                        </p>
                        <p>It's build quality and design is batter than elit. Numquam excepturi a debitis, sint voluptates, nam odit vel delectus id repellendus vero reprehenderit quidem totam praesentium vitae nesciunt deserunt. Sint, veniam?
                        </p>
                    </div>
                            ...
                            <div class="tab-content">
                                <div class="row">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <span class="ml-3 text-dark font-weight-semi-bold">Outstanding Design, Awesome Support</span>
                                    </div>
