@extends('layouts.tutors_room')
@section('title', 'Tutors Room')
@section('css/course')
...
<div class="wrapper">
    <nav class="navbar navbar-expand-lg navbar-custom " style="background-color: #009900;">
        ...
        <div class="col">
      <button class="btn btn-danger btn-sm mt-2" type="button" href="#!" data-toggle="modal" data-target="#tutor_roomModal" id="">
                                        Exit Session
                                    </button>
    </div>
    ...
    <div class="pages">
        <div class="page one">
            ...
            <div>
                ...
                <button1 onClick="slide('next')">Guest Page</button1>
            </div>
        ...
        <div class="page two">
            <h1>PAGE 2</h1>
            <div>
                <button1 onClick="slide('prev')">Previous</button1>
            </div>
        </div>
