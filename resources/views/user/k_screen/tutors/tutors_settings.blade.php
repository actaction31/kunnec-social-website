...
<div class="col-lg-12 rounded mb-2" style="background-color:#009900;">
    <div class="row">
		<div class="col-sm mt-2">
            <p><a href="{{ url('k_screen/tutors/tutors') }}" style="color: #FFFFFF"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Tutor</a><br><small style="color:#FFFFFF;"> ( Tutor Requirements: 2nd Monitor, Camera, & Microphone )</small></p>
        </div>
			...
			<div class="border p-card rounded">
				<div class="media">
			        <div class="row">
                        ...
                        <div class="col-sm">
                            <label for="card-holder-country" style="color: #F1C40F">Credit Price
                            </label>
					    ...
					    <div class="col-sm">
                            ...
                            <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                <label class="form-check-label" for="defaultcheckbox1"style="color: #FFFFFF">Expert ( 425 )
                                </label>
                            </div>
				        </div> 
					 
					    <div class="col-sm">
					        <label for="card-holder-country" style="color: #F1C40F">Available
                            </label>
					        <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            ...
                            <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                <label class="form-check-label" for="defaultcheckbox1"style="color: #FFFFFF">Thursdays( 425 )
                                </label>
                            </div>
						    <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                <label class="form-check-label" for="defaultcheckbox1"style="color: #FFFFFF">Fridays( 425 )
                                </label>
                            </div>
						    <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                <label class="form-check-label" for="defaultcheckbox1"style="color: #FFFFFF">Saturdays( 425 )
                                </label>
                            </div>
						    <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                <label class="form-check-label" for="defaultcheckbox1"style="color: #FFFFFF">Sundays( 425 )
                                </label>
                            </div>
				        </div>
					 
					    <div class="col-sm">
					        <label for="card-holder-country" style="color: #F1C40F">Ratings
                            </label> 
					        <div class="form-group form-check">
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
						    ...
						    <div class="form-group form-check">
                                ...
                                <label class="form-check-label" for="defaultcheckbox1">
                                    <div>
                                        <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1" style="color: #FFFFFF">3.5 & above(800)
                                        </span>
                                    </div>
							    </label>
                            </div>
						    ...
						    <button class="btn btn-warning mr-5 mb-1" type="button">
                                <a href="{{ url('k_screen/tutors/tutors_list') }}">Filter</a>
                            </button>
				        </div>
				    </div>
			    </div>
...
<div class="card">
	...
	<!-- Start of Tabs -->
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="setup-tab" data-toggle="tab" href="#tab-setup" role="tab" aria-controls="tab-setup" aria-selected="true">Tutor Setup</a></li>
			<li class="nav-item"><a class="nav-link" id="quiz-tab" data-toggle="tab" href="#tab-quiz" role="tab" aria-controls="tab-quiz" aria-selected="true">Quiz Setup</a></li>
            <li class="nav-item"><a class="nav-link" id="purchase-tab" data-toggle="tab" href="#tab-purchase" role="tab" aria-controls="tab-purchase" aria-selected="true">Tutoring List</a></li>
		    <li class="nav-item"><a class="nav-link" id="wish-tab" data-toggle="tab" href="#tab-wish" role="tab" aria-controls="tab-wish" aria-selected="true">Favorite Tutors</a></li>
                ...
                <div class="card">
                    <div class="card-body p-0">
					    ...
					    <div class="row no-gutters">
                            <div class="col-lg-8 pr-lg-2">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body bg-light">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="intro">Full Tutor Description</label>
                                        ...
                                        <div class="card-body bg-light">
                                            <a class="btn btn-primary d-block" href="{{ url('k_screen/tutors/tutors_details_view') }}" type="button">View Tutor Details</a>
                                        </div>
                                        <div class="card-body bg-light">
                                        ...
                                        <div class="col-lg-4 pl-lg-2">
                                            <div class="sticky-top sticky-sidebar">
			                                    <div class="card mb-3 overflow-hidden">
                                                    <div class="card-header">
                                                        <h5 class="mb-0">Tutor Cover Image</h5>
                                                    </div>
                                                    <div class="card-body bg-light">
                                                        <div class="pl-2">
                                                            <div class="container">
                                                ...
                                                <div class="card mb-3 overflow-hidden">
                                                                ...
                                                                <div class="container">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm">
                                                                            ...
                                                                            <h6 class="mt-2 font-weight-bold">Tutoring Level
                                                                                <span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="This will be the level you want the user to be when tutoring"><svg class="svg-inline--fa fa-question-circle fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zM262.655 90c-54.497 0-89.255 22.957-116.549 63.758-3.536 5.286-2.353 12.415 2.715 16.258l34.699 26.31c5.205 3.947 12.621 3.008 16.665-2.122 17.864-22.658 30.113-35.797 57.303-35.797 20.429 0 45.698 13.148 45.698 32.958 0 14.976-12.363 22.667-32.534 33.976C247.128 238.528 216 254.941 216 296v4c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12v-1.333c0-28.462 83.186-29.647 83.186-106.667 0-58.002-60.165-102-116.531-102zM256 338c-25.365 0-46 20.635-46 46 0 25.364 20.635 46 46 46s46-20.636 46-46c0-25.365-20.635-46-46-46z"></path></svg><!-- <span class="fas fa-question-circle"></span> -->
                                                                                </span>
                                                                            </h6>
                                                                            <div class="form-group">
                                                                                <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                    ...
                                                    <div class="card mb-3 overflow-hidden">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body bg-light">
                                                                <h5 class="fs-0">Delete Your Tutoring Account </h5>
                                                                <p class="fs--1">Once you delete this account, there is no going back. Please be certain.</p>
                                                                <a class="btn btn-danger d-block" href="#!" type="button" data-toggle="modal" data-target="#deleteModal">Delete Tutoring Account</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <!-- Start of New Tab -->
                            <div class="tab-pane fade" id="tab-quiz" role="tabpanel" aria-labelledby="quiz-tab">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-center justify-content-between">
                                            <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-book-reader"></i> &nbsp; Setup a Quiz</h5>
                                            </div>
                                        </div>
                                        <div class="table-responsive-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td>
                                                        <a href="k_course.php"><img src="../../../pages/course/images/sun.jpg" width="75px"></a>
                                                    </td>
                                                    <td>
                                                        <a href="k_course.php">The Direction is Always Up</a>
                                                    </td>
                                                    <td>
                                                        <a href="#!">Tupac Amoru Shakur</a>
                                                    </td>
                                                    <td>Math</td>
                                                    <td>02/21/1988</td>
                                                    <td>
                                                        <span class="badge badge-pill badge-warning">75</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
                                                    <td>
                                                        <a href="k_course.php"><img src="../../../pages/course/images/clouds.jpg" width="75px"></a>
                                                    </td>
                                                    <td>
                                                        <a href="k_course.php">The Sun Always shines</a>
                                                    </td>
                                                    <td>
                                                        <a href="#!">Marvin Gaye</a>
                                                    </td>
                                                    <td>Science</td>
                                                    <td>10/09/2017</td>
                                                ...
                                                <tr>
                                                    <th scope="row">3</th>
                                                    <td>
                                                        <a href="k_course.php"><img src="../../../pages/course/images/hands.jpg" width="75px"></a>
                                                    </td>
                                                    <td>
                                                        <a href="k_course.php">Two Can Keep A Secret if One is Dead</a>
                                                    </td>
                                                    <td><a href="#!">James Brown</a>
                                                    </td>
                                                    <td>English</td>
                                                    <td>11/16/2020</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th scope="row">4</th>
                                                    <td>
                                                        <a href="k_course.php"><img src="../../../pages/course/images/tree.jpg" width="75px"></a>
                                                    </td>
                                                    <td>
                                                        <a href="k_course.php">Always win at all cost, never fall</a>
                                                    </td>
                                                    <td>
                                                        <a href="#!">Carlo Gambino</a>
                                                    </td>
                                                    <td>Gym</td>
                                                    <td>03/1/2020</td>
                                                    <td>
                                                        <span class="badge badge-pill badge-warning">45</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">5</th>
                                                    <td>
                                                        <a href="k_course.php"><img src="../../../pages/course/images/ocean.jpg" width="75px"></a>
                                                    </td>
                                                    <td>
                                                        <a href="k_course.php">There is a I in win</a>
                                                    </td>
                                                    <td>
                                                        <a href="#!">Timagin</a>
                                                    </td>
                        ...
                        <div class="tab-pane fade" id="tab-purchase" role="tabpanel" aria-labelledby="purchase-tab">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                            <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-eye"></i> &nbsp; Tutors Watched</h5>
                                        </div>
                                    </div>
                                    <div class="table-responsive-sm">
                                        <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="{{ url('k_screen/tutors/tutors_details') }}">The Direction is Always Up</a></td>
                                                <td><a href="{{ url('k_screen/tutors/tutors_details') }}">Tupac Amoru Shakur</a></td>
                                                <td>Math</td>
                                                <td>02/21/1988</td>
                                                <td><span class="badge badge-pill badge-warning">75</span></td>
                                                </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">The Sun Always shines</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">Marvin Gaye</a>
                                                </td>
                                                <td>Science</td>
                                                <td>10/09/2017</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">Two Can Keep A Secret if One is Dead</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">James Brown</a>
                                                </td>
                                                <td>English</td>
                                                <td>11/16/2020</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">Always win at all cost, never fall</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">Carlo Gambino</a>
                                                </td>
                                                <td>Gym</td>
                                                <td>03/1/2020</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">There is a I in win</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">Timagin</a>
                                                </td>
                                                <td>Science</td>
                                                <td>03/1/2020</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('k_screen/tutors/tutors_details') }}">The Direction is Always Up</a>
                                                </td>
                    ...
                    <div class="tab-pane fade" id="tab-wish" role="tabpanel" aria-labelledby="wish-tab">
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-heart"></i> &nbsp; Tutors I want to learn from</h5>
                                    </div>
                                </div>
                    			<div class="table-responsive-sm">
						            <table class="table table-hover">
...
<!-- Functional JavaScript -->
	...
	<script type="text/javascript" src="../../js/imgprv.js"></script>
	<script type="text/javascript" src="../../assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="../../assets/js/popper.min.js"></script>
    <script type="text/javascript" src="../../assets/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/stickyfilljs/stickyfill.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/sticky-kit/sticky-kit.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/is_js/is.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/lodash/lodash.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/echarts/echarts.min.js"></script>
    <script type="text/javascript" src="../../assets/lib/progressbar.js/progressbar.min.js"></script>
