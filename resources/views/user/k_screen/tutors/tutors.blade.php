    ...
    <div class="row">
		<div class="col-sm mt-2">
            ...
            <a href="{{ url('k_screen/tutors/tutors') }}" style="color: #FFFFFF"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Tutor
                ...
                <a href="{{ url('k_screen/tutors/tutors_settings') }}" style="font-size:20px; color: #ffffff;">
...
<div class="card">
    ...
    <img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/2.jpg') }}" alt="Card image cap">
    <div class="card-body">
        <h6 class="fs-9">
            <strong>
                <a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp
                </a>
            </strong>
        </h6>
	...
	<div class="d-flex align-items-center justify-content-between px-3">
        ...
        <div>
            <a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Save Teacher">
	...
	<div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/1.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
		...
		<div class="d-flex align-items-center justify-content-between px-3">
            ...
            <div><a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Save Teacher"><span class="far fa-heart"></span></a>
			</div>
        </div>
    </div>
	
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/5.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/6.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Photoshop CS4 training</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
...
<div> <p class=" text-center" style="color: #FFFFFF"><strong>Top Rated Tutors</p></div>  
<div> <p class=" text-center" style="color: #009900"><strong>Trending Tutors</p></div>  
<div class="card-deck">

    <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/7.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
	...
	<div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/8.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/9.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('public/user-dash/k_screen/tutors/3.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_screen/tutors/tutors_details') }}" style="font-size: 1.0rem; color: #009900;">Photoshop CS4 training</a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
