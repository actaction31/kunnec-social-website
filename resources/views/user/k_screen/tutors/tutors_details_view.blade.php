                                ...
                                <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                                    <label class="form-check-label" for="defaultcheckbox1">
                                        <div>
                                            ...
                                            <span class="fa fa-star text-warning"></span>
                                            <span class="fa fa-star text-warning"></span>
                                            <span class="ml-1" style="color: #FFFFFF">3.0 & above(20)
                                            </span>
                                        </div>
                                    </label>
                            </div>
                            
                            <button class="btn btn-warning mr-5 mb-1" type="button"><a href="{{ url('k_screen/tutors/tutors_list') }}">Filter</a>
                            </button>
                        </div>
				    </div>
			    </div>
        ...
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50"><a class="d-block h-50"><img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/tutors/2.jpg') }}" alt="" /></a>
                ...
                <div class="col-lg-6">
                <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" >
                    <a href="{{ url('k_screen/tutors/tutors_settings') }}" style="color: #FFFFFF;"><span class="fas fa-edit"></span> Back to Tutor Details Setup </a>
                </button>
				...
				<p class="fs--1 mb-2 mb-md-3">
                    <small class="mr-1">Tutor: </small>
                    <img src="{{ asset('public/user-dash/images/users/profiles/20.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                </p>
                <h4 class="d-flex align-items-center">
                    <span class="text-warning mr-2">400 Credits</span>
                    <span class="mr-1 fs--1 text-500"> per 15 mins.
                </h4>
                    ...
                    <div class="nav-bar">
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content">
					            <div class="nav-bar-item active pl-0 pr-2 pr-sm-4"></div>
