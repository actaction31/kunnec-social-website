            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50">
                        <img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_screen/tutors/5.jpg') }}" alt="" />
                    </div>
                </div>
            </div>

            <div class="col-lg-6">
                <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#tutorModal">
                    <span class="fas fa-handshake"></span> Enter Tutoring Session 
                </button>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-auto pl-3 pl-sm-0">
                        <a class="btn btn-sm btn-outline-danger border-300 mr-2 mt-2 mt-sm-0" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Tutor List">
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content">
					        <div class="nav-bar-item active pl-0 pr-2 pr-sm-4">
						        ...
						        <button class="btn btn-primary mr-1 mb-1" type="button">See My Kunnec to You
                                    <span class="fas fa-smile-wink ml-1" data-fa-transform="shrink-3"></span>
                                </button>
                            </div>
