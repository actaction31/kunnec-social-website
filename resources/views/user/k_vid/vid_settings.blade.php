...
<div class="card">
	...
	<!-- Start of Tabs -->
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="setup-tab" data-toggle="tab" href="#tab-setup" role="tab" aria-controls="tab-setup" aria-selected="true">Upload Video</a></li>
            <li class="nav-item"><a class="nav-link" id="course-tab" data-toggle="tab" href="#tab-course" role="tab" aria-controls="tab-course" aria-selected="false">My Videos</a></li>
            <li class="nav-item"><a class="nav-link" id="purchase-tab" data-toggle="tab" href="#tab-purchase" role="tab" aria-controls="tab-purchase" aria-selected="true">Videos Viewed</a></li>
		    <li class="nav-item"><a class="nav-link" id="wish-tab" data-toggle="tab" href="#tab-wish" role="tab" aria-controls="tab-wish" aria-selected="true">Favorite Channel</a></li>
        ...
        <div class="tab-content border-x border-bottom p-3" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-setup" role="tabpanel" aria-labelledby="setup-tab">
                    ...
                    <div class="card-body p-0">
					    ...
					    <div class="row no-gutters">
                            <div class="col-lg-8 pr-lg-2">
                                    ...
                                    <div class="card-body bg-light">
                                        <form>
                                            <div class="row">
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="heading">Title of Video</label>
                                                        <input class="form-control" id="heading" type="text">
                                                    </div>
                                                </div>
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="heading">Video Description</label>
                                                        <input class="form-control" id="heading" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="intro">Video More Info Section</label>
                                ...
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h5 class="mb-0">Video Playlist</h5>
                                    </div>
                                    <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center" href="#experience-form" data-toggle="collapse" aria-expanded="false" aria-controls="experience-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ml-3">Add a Playlist</span></a>
                                        <div class="collapse" id="experience-form">
                                            <form>
                                                ...
                                                <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center" href="#education-form" data-toggle="collapse" aria-expanded="false" aria-controls="education-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ml-3">Add a Video</span></a>
                                                    <div class="collapse" id="education-form">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-3 text-lg-right">
                                                                        <label class="mb-0" for="edu-to">Upload Youtube Link</label>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-7 offset-lg-3">
                                                                        <button class="btn btn-warning" type="button">Save Video</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                        <hr class="border-dashed border-bottom-0 my-4" />
							                            <button class="btn btn-success" type="button">Add Playlist</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">Save Video Playlist</h5>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-primary d-block" href="{{ url('k_course/course_details_view') }}" type="button" href="#!">View Video </a>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-success d-block" href="#!" type="button" href="#!">Save Video</a>
                                    </div>
                                </div>
                                <div class="col-lg-4 pl-lg-2">
                                    <div class="sticky-top sticky-sidebar">
                                        <div class="card mb-3 overflow-hidden">
                                            <div class="card-header">
                                                <h5 class="mb-0"> K-Ads</h5>
                                            </div>
                                            <div class="card-body bg-light">
                                                <h6 class="font-weight-bold">Do you want to add K-Ads ?<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="Will users view your course for free or pay"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="pl-2">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="view-settings" id="free" />
                                                        <label class="custom-control-label" for="free">Yes
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="view-settings" id="credits" checked="checked" />
                                                        <label class="custom-control-label" for="credits">No
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <h6 class="font-weight-bold">Do you want skip K-Ads button ?<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="Will users view your course for free or pay"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="pl-2">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="view-settings" id="free" />
                                                        <label class="custom-control-label" for="free">Yes
                                                ...
                                                <h6 class="font-weight-bold">Please go under your Account and select K-Ads for Kunnec Vid .</h6>
                                                
					
					                            <hr class="border-dashed border-bottom-0">

                                                <h6 class="mt-2 font-weight-bold">Video Classification<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="This will be the level the user must be when viewing your video"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="form-group">
                                                    <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body bg-light">
                                                    <div class="container">
                                                        <h5 class="fs-0">Delete this Video</h5>
                                                        <p class="fs--1">Once you delete this video, there is no going back. Please be certain.</p><a class="btn btn-danger d-block" href="#!" type="button" href="#!" data-toggle="modal" data-target="#deleteVideoModal">Delete Video</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-th-list"></i> &nbsp;My Videos</h5>
                                </div>
                            </div>
                            <div class="table-responsive-sm">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><a href="{{ url('k_course/course_details') }}"><img src="{{ asset('public/user-dash/k_course/courses/sun.jpg') }}" width="75px"></a></td>
                                        ...
                                        <tr>
                                            <th scope="row">2</th>
                                            <td><a href="{{ url('k_course/course_details') }}"><img src="{{ asset('public/user-dash/k_course/courses/clouds.jpg') }}" width="75px"></a></td>
                                        ...
                                        <tr>
                                            <th scope="row">3</th>
                                            <td><a href="{{ url('k_course/course_details') }}"><img src="{{ asset('public/user-dash/k_course/courses/hands.jpg') }}" width="75px"></a></td>
                                        ...
                                        <tr>
                                            <th scope="row">4</th>
                                            <td><a href="{{ url('k_course/course_details') }}"><img src="{{ asset('public/user-dash/k_course/courses/tree.jpg') }}" width="75px"></a></td>
                                        ...
                                        <tr>
                                            <th scope="row">5</th>
                                            <td><a href="{{ url('k_course/course_details') }}"><img src="{{ asset('public/user-dash/k_course/courses/ocean.jpg') }}" width="75px"></a></td>
                ...
                <!-- Start of PurchasedVideos Viewed Tab -->
                <div class="tab-pane fade" id="tab-purchase" role="tabpanel" aria-labelledby="purchase-tab">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-dollar-sign"></i> &nbsp; Videos Viewed</h5>
                                </div>
                            </div>
                            <div class="table-responsive-sm">
                                <table class="table table-hover">
                ...
                <div class="tab-pane fade" id="tab-wish" role="tabpanel" aria-labelledby="wish-tab">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-heart"></i> &nbsp;Favorite Channels</h5>
                                </div>
                            </div>
                        <div class="table-responsive-sm">
                            <table class="table table-hover">
