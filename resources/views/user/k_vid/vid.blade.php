...
<div class="col-lg-12 rounded mb-2" style="background-color:#009900;">
    <div class="row">
		<div class="col-sm mt-2">
            <p>
                <a href="{{ url('k_vid/vid') }}" style="color: #FFFFFF"><img src="{{ asset('public/images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Show</a>
            |&nbsp;
                <a href="{{ url('k_vid/vid_settings') }}" style="font-size:20px; color: #ffffff;">
	    ...
	    <div class="row p-3">
            ...
            <form class="form-inline">
                <div class="md-form my-0">
                    <input class="form-control" type="text" placeholder="Search Vids" aria-label="Search">
                </div>
				<div class="ml-2">
		...
		<div class="border p-card rounded">
			<div class="media">
				<div class="row">
					...
					<div class="col-sm-3">
					    <label for="card-holder-country" style="color: #F1C40F">Video</label>
					    <div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Everyone</label>
                        </div>
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Mature</label>
                        </div>
						
						<label for="card-holder-country" style="color: #F1C40F">Length</label>
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">( 4 minutes or below )</label>
                        </div>
					    <div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox2" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox2" style="color: #FFFFFF">( 5 minutes to 10 minutes )</label>
                        </div>
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox3" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox3" style="color: #FFFFFF">( 11 minutes to 15 minutes )</label>
                        </div>
						
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox4" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox4" style="color: #FFFFFF">( 16 minutes and above )</label>
                        </div>
					</div>
					 
					<div class="col-sm">
					    <label for="card-holder-country" style="color: #F1C40F">Options</label>
					    <div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Vidcast</label>
                        </div>
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Playlists</label>
                        </div>
						<div class="form-group form-check">
                            <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Videos</label>
                        </div>
						<label for="card-holder-country" style="color: #F1C40F">Sort</label>
						<div class="form-group form-check">
						    <input class="form-check-input" id="defaultcheckbox1" type="checkbox">
                            <label class="form-check-label" for="defaultcheckbox1" style="color: #FFFFFF">Views </label>
                        </div>
					</div> 
					...
					<div class="col-sm-3">
						...
						<button class="btn btn-warning mr-5 mb-1" type="button">
                            <a href="{{ url('k_vid/vid_list') }}">Filter</a>
                        </button>
				    </div>
				</div>
			</div>
...
<div class="card">
    <div class="card-body">
        <div class="col-lg-12">
            <div class="carousel slide" id="carouselExampleCaptions" data-ride="carousel">
                ...
                <div class="carousel-inner rounded">
                    <div class="carousel-item active"><img class="d-block w-100" src="{{ asset('public/user-dash/k_vid/thumbs/10.jpg') }}" height="400" alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="text-white">First Slide Heading</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="carousel-item"><img class="d-block w-100" src="{{ asset('public/user-dash/k_vid/thumbs/11.jpg') }}" height="400" alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="text-white">First Slide Heading</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="carousel-item"><img class="d-block w-100" src="{{ asset('public/user-dash/k_vid/thumbs/12.jpg') }}" height="400" alt="Third slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="text-white">First Slide Heading</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                ...
                <a class="carousel-control-next" href="#carouselExampleCaptions" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span>
                </a>
            </div>
        </div>

        <!-- Start of Top Rated Block -->
	    ...
	    <div id="card">
		    <div id="container">
			    <i class="fas fa-star" data-toggle="tooltip" data-placement="bottom" title="Trending" style="color: #009900;"></i>
			    Live Shows
			    <div class="card-deck">
			        <div class="card" style="width: 18rem;">
                        <div class="card-img-top">
					        <div class="hovereffect">
					            <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/6.jpg') }}" alt="Card image cap">
					                <div class="overlay">
									
									    <h2>
										    <span class="badge badge-light"><small class="text-green">2:27</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">21 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 2 days ago</small></p>
										</h2>
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;"><a class="info" href="{{ url('k_vid/vid_screen') }}">Video card title</a></h5>
                    ...
                    <div class="card" style="width: 18rem;">
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/9.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <span class="badge badge-light"><small class="text-green">9:18</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">30 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 6 months ago</small></p>
										</h2>
                                        <a class="info" href="{{ url('k_vid/vid_screen') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt="" /></a>
		                            </div>
                            </div>
					...
					<div class="card" style="width: 18rem;">
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/12.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <span class="badge badge-light"><small class="text-green">9:18</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">101 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 1 year ago</small></p>
										</h2>
                                        <a class="info" href="{{ url('k_vid/vid_screen') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt="" /></a>
		                            </div>
                            </div>
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;"><a class="info" href="{{ url('k_vid/vid_screen') }}">Mountains Look Great</a></h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/12.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Schoolboy</h5>
                                </div>
			                </div>
	                    </div>
                    </div>
				    ...
				    <div class="card" style="width: 18rem;">
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/7.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <span class="badge badge-light"><small class="text-green">20:43</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">30 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 6 months ago</small></p>
										</h2>
                                        <a class="info" href="{{ url('k_vid/vid_screen') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt=""/></a>
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;"><a class="info" href="{{ url('k_vid/vid_screen') }}">Coffee on the Night-Stand</a></h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/12.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Joshua</h5>
                                </div>
			                </div>
	                    </div>
                    </div>
					...
					<div class="card" style="width: 18rem;">
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/8.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <span class="badge badge-light"><small class="text-green">17:25</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">243 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 4 weeks ago</small></p>
										</h2>
                                        <a class="info" href="{{ url('k_vid/vid_screen') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt="" /></a>
		                            </div>
                            </div>
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;"><a class="info" href="{{ url('k_vid/vid_screen') }}">Sweater with Coffee</a></h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/3.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Rebecca</h5>
                                </div>
			                </div>
	                    </div>
                    </div>
		    ...
		    <div id="container">
			    ...
			    <div class="card-deck">
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;"><a class="info" href="{{ url('k_vid/vid_screen') }}">Awesome card title</a></h5>
	                        <div class="media align-items-center">
			                    <div class="avatar avatar-m">
							        <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" alt="" />
                                </div>
        ...
        <br>
			...
			<div class="card-deck">
			    <div class="card" style="width: 18rem;">
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <a href="{{ url('k_vid/vid_screen') }}"><img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/1.jpg') }}" alt="Card image cap"></a>
								    <div class="overlay">
									    <h2>
                        ...
                        <div class="card-img-top">
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/5.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <span class="badge badge-light"><small class="text-green">8:25</small></span>
										    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">1,200,465 Views </small><small class="text-white"> | </small></p>
	                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white"> 17 days ago</small></p>
										</h2>
                                        <a class="info" href="{{ url('k_vid/vid_screen') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt="" /></a>
		                            </div>
                            </div>
	...
	<!-- Start of Trending Block -->
		<br>
            <hr class="style12">
        <br>
	<i class="fas fa-music" title="Trending" style="color: #009900;"></i>
			Music Videos
			<div class="card-deck">
				            ...
				            <div class="hovereffect">
				                <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/1.jpg') }}" alt="Card image cap">
								    <div class="overlay">
                                        ...
                                        <a class="info" href="#"><img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/play.png') }}" height="50px" width="50px" alt="" /></a>
		                            </div>
                            </div>
						</div>			
                        <div class="card-body">
                ...
                <div class="card" style="width: 18rem;">
			        ...
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;">Dark Nights in Gotham</h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/14.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Michael</h5>
                                </div>
	        ...
	        <div class="card-deck">
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;">Awesome card title</h5>
	                        <div class="media align-items-center">
			                    <div class="avatar avatar-m">
							        <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" alt="" />
                                </div>
					...
					<div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;">Mountains Look Great</h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/12.jpg')}}" alt="" />
                                </div>
				    ...
				    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;">Coffee on the Night-Stand</h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/11.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Joshua</h5>
                                </div>
					...
					<div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 1.0rem;">Sweater with Coffee</h5>
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
            ...
            <hr class="style12">
        <br>
	<i class="fas fa-running" title="Trending" style="color: #009900;"></i>
			Sports
			<div class="card-deck">
                ...
                <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/15.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Jessica</h5>
                                </div>
			        ...
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/4.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Michael</h5>
                                </div>
        ...
        <br>
			...
			<i class="fas fa-gamepad" title="Trending" style="color: #009900;"></i>
			Gaming
			<div class="card-deck">
                ...
                <div class="card" style="width: 18rem;">
			        ...
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/18.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Michael</h5>
                                </div>
	...
	<!-- Start of Latest Block -->
		<br>
            <hr class="style12">
        <br>
	    
	    <i class="fas fa-balance-scale" title="Trending" style="color: #009900;"></i>
			News & Politics
			<div class="card-deck">
			    ...
			    <div class="card" style="width: 18rem;">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/20.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Jessica</h5>
                                </div>
					...
					<div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/1.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Michael</h5>
                                </div>
	    ...
	    <i class="fas fa-magic" title="Trending" style="color: #009900;"></i>
			Entertainment
			<div class="card-deck">
			        ...
			        <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/16.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <h5 class="mb-0 fs-0">Lea</h5>
                                </div>
