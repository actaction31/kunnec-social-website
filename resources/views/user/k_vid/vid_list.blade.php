			            ...
			            <div class="card-body">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-sm-auto mb-2 mb-sm-0">
                                    <h6 class="mb-0">Showing 205 of Bookkeeping</h6>
                                </div>
                    ...
                    <div class="p-1">
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="k_vid_channel.php"><img src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="mt-md-2"><a class="btn btn-sm btn-outline-success border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="k_vid_channel.php" style="color:#FFFFFF;" ><span class="fas fa-eye" style="color:#009900;"></span><span class="ml-2 d-none d-md-inline-block">View My Channel</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="#!"><span class="fas fa-plus"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Notify Me</font></span></a>
									    </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/24.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="mt-md-2"><a class="btn btn-sm btn-outline-success border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!" style="color:#FFFFFF;" ><span class="fas fa-eye" style="color:#009900;"></span><span class="ml-2 d-none d-md-inline-block">View My Channel</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="k_course_details.php"><span class="fas fa-plus"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Notify Me</font></span></a>
									    </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/23.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/22.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/21.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/20.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/19.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/18.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-9">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_vid/vid_screen') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/17.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
