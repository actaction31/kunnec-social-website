...
<div class="row">
    <div class="col-sm-8">
        ...
        <div class="card bg-light">
            <div class="card-img-top" style="height: 40rem;">
                <div id="video">
                </div> 
            </div>
        </div>
        ...
        <div class="card mt-2 mb-3">
            <div class="">
                ...
                <div class="card-body">
                    <h5 class="card-title">Big Buck vs Three Vermits</h5>
                    <small class="text-muted"> Published: April 4, 2020 </small>
                        <br>
                        <hr class="style12">
                        
                        <div class="d-flex w-100 justify-content-between">
                            <div class="row  pl-1 m-1 d-inline-block ">
                                <div class="row">
                                    <div class="col-sm">
                                        <a href="{{ url('k_vid/vid_channel') }}"><img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/18.jpg')}}" height="40px" width="40px" alt="" />
                                    </div>
                                    <div class="col-sm">
                                        <h5 class="mb-0 fs-0" style="color: #009900;"> {{Auth::user()->username}}</h5></a>
                                    </div>
                                </div>
                            </div>
                            <ul class="list-inline">
                                <li class="list-inline-item"><small class="text-muted"> Rate: </small></li>
                                <li class="list-inline-item"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span> | </li>
                                <li class="list-inline-item"> 4233 Views </li>
                            </ul>
                        </div>
                        
                        <div class="d-flex w-100 justify-content-between">
                            <div class="row pl-1 m-1">
                                <li class="list-inline-item"><button class="btn btn-success mr-1 mb-1" type="button"><span class="fas fa-plus mr-1" data-fa-transform="shrink-3" style="color:#FFFFFF;"></span>Subscribe</button></li>							
                                <small class="text-muted"><button class="btn btn-outline-success btn-sm rounded-capsule" type="button"><span data-fa-transform="shrink-3"></span>2435</button></small>
                            </button></small>
                            </div>									
                            <ul class="list-inline">
                                <li class="list-inline-item"><i class="far fa-bell fa-2x" data-toggle="tooltip" data-placement="bottom" title="Get Notified" style="color: #009900;"></i></li>
                            </ul>
                        </div>
                        ...
                        <p>
                            <button class='btn btn-falcon-default btn-sm rounded-capsule pushme2' type="button" data-toggle="collapse" data-target="#collapseEmbed" aria-expanded="false" aria-controls="collapseEmbed">More Info
                            </button>
                        </p>
                        <div class="collapse" id="collapseEmbed">
                            <div class="card card-body">
                               <table class="table">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col"><input class="form-control-plaintext" id="staticEmail" type="text" readonly="" value=' <iframe src="https://kunnec.com/ frameborder="0" width="700" height="400" allowfullscreen></iframe> '></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div class="card-header bg-light">
                            ...
                            <div class="col">
                                <div class="col-auto">
                                    <div class="dropdown text-sans-serif">
                                        <button class="btn btn-sm dropdown-toggle p-1 dropdown-caret-none" type="button" id="post-album-action" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>
                        ...
                        <div class="card-footer bg-light pt-0">
                            <div class="row no-gutters font-weight-semi-bold text-center py-2 fs--1">
                                <div class="col-auto"><a class="rounded d-flex align-items-center mr-3" href="#!"><img src="images/illustrations/comment-active.png" width="20" alt="" /><span class="ml-1">Comments</span></a>
                                </div>
                            </div>
                            ...
                            <div class="media mt-3">
                                ...
                                <div class="media-body ml-2 fs--1">
                                    <p class="mb-1 bg-200 rounded-soft p-2"><a class="font-weight-semi-bold" href="{{ url('profile') }}">Rowan Atkinson</a> She starred as Jane Porter in The , Tanya Vanderpoel in Whiskey Tango Foxtrot (2016) and as DC comics villain Harley Quinn in Suicide Squad (2016), for which she was nominated for a Teen Choice Award, and many other awards.</p>
                            ...
                            <div class="media mt-3">
                                ...
                                <div class="media-body ml-2 fs--1">
                                    <p class="mb-1 bg-200 rounded-soft p-2"><a class="font-weight-semi-bold" href="{{ url('profile') }}">Jessalyn Gilsig</a> Jessalyn Sarah Gilsig is a Canadian-American actress known for her roles in television series, e.g., as Lauren Davis in Boston Public, Gina Russo in Nip/Tuck, Terri Schuester in Glee, and as Siggy Haraldson on the History Channel series Vikings. ðŸ†</p>
                    ...
                    <div class="col-sm pb-3">
                        <div class="card mb-3" >
                            <div class="card-body">
                                <div class="d-flex w-100 justify-content-between">
                                    <div class="row pl-1 m-1">
                                        <i class="fas fa-fast-forward fa-2x" style="color: #009900;"></i>
                                        <h5 class="mb-0 fs-0" style="color: #009900;">  &nbsp Next Vid </h5>
                                    </div>
                                    <ul class="list-inline">
                                        <li class="list-inline-item" style="color: #009900;"> Autoplay </li>
                                        <li class="list-inline-item"><label class="switch"><input type="checkbox"><span class="slider round"></span></li>
                                    </ul>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    <div class="avatar avatar-m">
                                        <img class="rounded-circle" src="{{ asset('public/user-dash/k_vid/thumbs/13.jpg') }}" alt="" />
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-deck">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-img-top">
                                        <div class="hovereffect">
                                            <img class="img-fluid" src="{{ asset('public/user-dash/k_vid/thumbs/10.jpg') }}" alt="Card image cap">
                                                <div class="overlay">
                                                    <h2>
                                                        <span class="badge badge-light"><small class="text-green">11:04</small></span>
                                                        <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">200,421 Views </small><small class="text-white"> | </small></p>
                            ...
                            <div class="card-deck">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-m">
                                                <img class="rounded-circle" src="{{ asset('public/user-dash/images/users/profiles/9.jpg')}}" alt="" />
                                            </div>
                                            <div class="media-body ml-2">
                                                <h5 class="mb-0 fs-0">Michael</h5>
                                            </div>
...
@section('additional-js')
    ...
    <script src=" {{ asset('public/user-dash/js/IScroll4Custom.js') }}" type="text/javascript"></script>
    <script src=" {{ asset('public/user-dash/js/THREEx.FullScreen.js') }}" type="text/javascript"></script>
    <script src=" {{ asset('public/user-dash/js/Playlist.js') }}" type="text/javascript"></script>
    <script src=" {{ asset('public/user-dash/js/videoPlayer.js') }}" type="text/javascript"></script>
    <script src=" {{ asset('public/user-dash/js/videoPlayer1.js') }}" type="text/javascript"></script>
