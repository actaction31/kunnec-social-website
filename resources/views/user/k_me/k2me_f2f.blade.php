...
<div class="card-header1 mt-3">
    Face to Face Interview ( Must have a Camera ) 
</div>
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <button type="button" class="btn1 btn-kunnec"  href="#!" data-toggle="modal" data-target="#interviewModal">Start Interview</button>
            </div>
        </div>
        <hr class="style12">
    </div>  
