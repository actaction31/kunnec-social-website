...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    <h4 class="border-bottom border-gray pb-2 mb-0">Finance Basics</h4>
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center mt-3">
            ...
            <li class="page-item active" style="background: #009900;">
    ...
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        <h6 class="border-bottom border-gray pb-2 mb-0"> {{ date('m-d-Y') }}</h6>
        <!-- Posting's Today section -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/18.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
                </button>
            </div>
        </div>
        <!-- 2nd Post that day -->
    ...
    <!-- Previous Day -->
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        <h6 class="border-bottom border-gray pb-2 mb-0">07-28-2021</h6>
        <!-- Posting's Previous section -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
    ...
    <!-- Previous Day -->
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        <h6 class="border-bottom border-gray pb-2 mb-0">07-27-2021</h6>
        <!-- Posting's Previous section -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/15.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
    ...
    <!-- Previous Day -->
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        <h6 class="border-bottom border-gray pb-2 mb-0">07-26-2021</h6>
        <!-- Posting's Previous section -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/13.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
        ...
        <!-- 2nd Post that day -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/12.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/11.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
        ...
        <!-- 2nd Post that day -->
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/10.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            <img class="bd-placeholder-img mr-2 rounded" width="32" height="32" src="{{ asset('public/user-dash/images/users/profiles/9.jpg')}}" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32">
            </img> A strong investor understanding crypto currency!
            <div class="d-inline float-right">
                <button type="button" class="btn1 btn-success" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
