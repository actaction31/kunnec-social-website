...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            ...
            <div class="d-inline float-right">
                Post ends in 5 days.
                <button type="button" class="btn1 btn-primary" style="margin-top: -2px;" >
                    <a href="{{ url('k_me/k2me_applicants') }}" style="color: #ffffff; font-size: 12px;">Applicants</a> <span class="badge"  style="color: #ffffff;">1</span>
                </button>
                <button type="button" class="btn1 btn-kunnec" style="margin-top: -2px;">
                ...
                <button type="button" class="btn1 btn-danger" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">Delete</a>
                </button>
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            ...
            Post ends in 5 days.
                <button type="button" class="btn1 btn-primary" style="margin-top: -2px;" >
                    <a href="{{ url('k_me/k2me_applicants') }}" style="color: #ffffff; font-size: 12px;">Applicants</a> <span class="badge"  style="color: #ffffff;">4</span>
                </button>
                <button type="button" class="btn1 btn-kunnec" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
                </button>
    ...
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            ...
            Post ends in 5 days.
                <button type="button" class="btn1 btn-primary" style="margin-top: -2px;" >
                    <a href="{{ url('k_me/k2me_applicants') }}" style="color: #ffffff; font-size: 12px;">Applicants</a> <span class="badge"  style="color: #ffffff;">3</span>
                </button>
                <button type="button" class="btn1 btn-kunnec" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
                </button>
                <button type="button" class="btn1 btn-danger" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_delete') }}" style="color: #ffffff; font-size: 12px;">Delete</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="media-body pt-3 mb-0 small lh-125 border-bottom border-gray">
        ...
        <div class="alert alert-success" alert-dismissible fade show role="alert">
            ...
            Post ends in 5 days.
                <button type="button" class="btn1 btn-primary" style="margin-top: -2px;" >
                    <a href="{{ url('k_me/k2me_applicants') }}" style="color: #ffffff; font-size: 12px;">Applicants</a> <span class="badge"  style="color: #ffffff;">7</span>
                </button>
                <button type="button" class="btn1 btn-kunnec" style="margin-top: -2px;">
                    <a href="{{ url('k_me/k2me_post') }}" style="color: #ffffff; font-size: 12px;">View Post</a>
                </button>
                <button type="button" class="btn1 btn-danger" style="margin-top: -2px;">
                    <a href="#!" style="color: #ffffff; font-size: 12px;">Delete</a>
                </button>
            </div>
        </div>
    </div>
