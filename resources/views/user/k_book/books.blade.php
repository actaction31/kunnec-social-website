...
<div class="card">
	<div class="card-body">
		<p Style="color:#009900;"> New Releases </p>
		<hr class="style12">
        <div class="card-deck">
			<div class="card" style="width: 18rem;">
				...
				<br>				
								...
								<p Style="color:#009900;"> Best Sellers </p>
			    <hr class="style12">
                <div class="card-deck">
					<div class="card" style="width: 18rem;">
					    <div class="card-img-top">
				            ...
				            <div class="hovereffect">
				               <img class="img-fluid" src="{{asset('user-dash/k_book/book_covers/gas.jpg')}}" alt="Card image cap">
								    <div class="overlay">
										...
										<h3><span class="badge badge-warning"><i class="fas fa-book"></i><small class="text-green"> 94 </small><small class="text-green"> Credits </small></span></h3></a>
										</div>
                            </div>
						</div>			
                        <div class="card-body">
				...
				<br>				
								...
								<p Style="color:#009900;"> Top Rated </p>
			    <hr class="style12">
                <div class="card-deck">
					<div class="card" style="width: 18rem;">
					    <div class="card-img-top">
					...
					<div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
						    ...
						    <div class="media align-items-center">
			                    <div class="avatar avatar-m">
                                    <img class="rounded-circle" src="{{asset('user-dash/images/users/profiles/11.jpg')}}" alt="" />
                                </div>
                                <div class="media-body ml-2">
                                    <small class="text-black d-inline"> by:</small><h5 class="mb-0 fs-0 d-inline"> Michael</h5><br>
									<small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
