        ...
        <div class="row">
            <div class="col-sm-3 col-md-2">
                <div class="hovereffect">
				    <img class="img-fluid" src="{{asset('user-dash/k_book/book_covers/empire.jpg')}}" alt="Card image cap">
					<div class="overlay">
						<h2>
							<a href="{{ url('k_book/book_details') }}">
							<p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Published: April 4, 2020  </small><small class="text-white"> | </small></p>
						...
						<h3>
                            <span class="badge badge-warning"><i class="fas fa-book"></i><small class="text-green"> 75 </small><small class="text-green"> Credits </small></span>
                        </h3>
                        </a>
					</div>
                </div>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/9.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
	                                       ...
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
										   <small class="text-muted"> Audiobook: </small><small class="text-green d-inline" style="color:#009900;"><i class="fas fa-volume-up"></i> &nbsp;<span class="badge badge-warning"> 120 </span><small class="text-green"> Credits </small></small><br>
                                           <small class="text-muted"> Length: </small><small class="text-green d-inline" style="color:#009900;"></i><small class="text-green"> 12 parts </small> / <small class="text-green"> 11 hours</small></small>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="mt-md-2"><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_book/book_details') }}"><span class="fas fa-eye"></span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">View Book Details</font></span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="k_books_library.php"><span class="fas fa-heart"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Add to Library</font></span></a>
									    </div>
                                    </div>
                                </div>
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{asset('user-dash/k_book/book_covers/chin.jpg')}}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_book/book_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Published: April 4, 2020  </small><small class="text-white"> | </small></p>
										...
										<h3><span class="badge badge-warning"><i class="fas fa-book"></i><small class="text-green"> 75 </small><small class="text-green"> Credits </small></span></h3></a>
										</div>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/10.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-muted"> Audiobook: </small><small class="text-green d-inline" style="color:#FF0000;"><i class="fas fa-times-circle"></i></small> <br>
                                           <ul class="list-unstyled d-none d-lg-block">
										   <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span></li>
                                        </ul>
                                    </div>
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{asset('user-dash/k_book/book_covers/gas.jpg')}}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_book/book_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Published: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/11.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{asset('user-dash/k_book/book_covers/barack.jpg')}}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_book/book_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Published: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/12.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="mt-md-2"><a class="btn btn-sm btn-success d-lg-block mt-2" href="k_books_details.php"><span class="fas fa-eye"></span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">View Book Details</font></span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="k_books_library.php"><span class="fas fa-heart"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Add to Library</font></span></a>
									    </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/13.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/14.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/15.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/16.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_book/book_details') }}">The Worst President in History</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><a href="{{ url('k_book/book_details') }}"><img src="{{asset('user-dash/images/users/profiles/17.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Fiction</small><br>
									       <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 274</small><br>
	                                       <hr class="style12">
										   <small class="text-black d-inline">Narrated by:</small><h5 class="mb-0 fs-0 d-inline"> Michael Chang</h5><br>
