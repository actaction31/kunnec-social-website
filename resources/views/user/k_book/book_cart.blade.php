            ...
            <div class="card mb-3">
                <div class="card-header bg-light">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-sm-auto">
                            <h5 class="mb-2 mb-sm-0">Books in Cart: 2</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-2">
                            <p class="font-weight-bold">BOOK ( 1 )</p>
                        </div>
                        <div class="col-sm-2">
                            <a  href="{{ url('k_book/book_details') }}">
                                <img class="img-fluid" src="{{ asset('user-dash/k_book/book_covers/barack.jpg') }}" width="125px"alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm">
                            <a  href="{{ url('k_book/book_details') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <p class="font-weight-bold">BOOK ( 2 )</p>
                        </div>
                        <div class="col-sm-2"  href="{{ url('k_book/book_details') }}">
                            <a  href="{{ url('k_shop/shop_details') }}">
                                <img class="img-fluid" src="{{ asset('user-dash/k_book/book_covers/chin.jpg') }}" width="125px"alt="Card image cap">
                            </a>    
                        </div>
                        <div class="col-sm">
                            <a  href="{{ url('k_book/book_details') }}">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a  href="{{ url('k_book/book_details') }}">
                                <img class="img-fluid" src="{{ asset('user-dash/k_book/book_covers/empire.jpg') }}" width="125px"alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm">
                            <a  href="{{ url('k_book/book_details') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2"  href="{{ url('k_book/book_details') }}">
                            <a  href="{{ url('k_book/book_details') }}">
                                <img class="img-fluid" src="{{ asset('user-dash/k_book/book_covers/gas.jpg') }}" width="125px"alt="Card image cap">
                            </a>    
                        </div>
                        <div class="col-sm">
                            <a  href="{{ url('k_book/book_details') }}">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5 col-xl-12 col-xxl-5 pl-lg-4 pl-xl-2 pl-xxl-5 text-center text-md-left text-xl-center text-xxl-left">
                      ...
                      <a  href="{{ url('k_book/book_receipt') }}">
