        ...
        <div class="card-header bg-white">
            <div class="row justify-content-between">
                ...
                <div class="flex-col my-auto">
                    <h6 class="ml-auto mr-3"> <a href="{{ url('k_book/book_details') }}">View Details</a> </h6>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="media flex-column flex-sm-row">
                <div class="media-body ">
                    <h5 class="bold">Barack Obama Book</h5>
                ...
                </div><img class="align-self-center img-fluid" src="{{asset('user-dash/k_book/book_covers/barack.jpg')}}" width="180 " height="180">
            </div>
        </div>
        <div class="row px-3">
            <div class="col">
