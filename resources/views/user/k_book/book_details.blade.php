        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <a class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="{{ url('k_book/book_cart') }}" ><span class="fas fa-donate"></span> Purchase Book </a></button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#bookModal"><span class="fas fa-donate"></span> Purchase PDF Book </a></button>
                    </div>
                </div>
				...
				<div class="row">
                    ...
                    <div class="col-sm">
                        <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#audioModal">
                        <span class="fas fa-donate"></span> Purchase Audio Book </a></button>
                    </div>
                </div>
			</div>
        </div>
                ...
                <div class="fancy-tab overflow-hidden mt-4">
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content">
					        <div class="nav-bar-item active pl-0 pr-2 pr-sm-4">
                                <div class="mt-1 fs--1">
                                    <strong>Books By the Author</strong>
                                </div>
                            </div>
                            <hr class="style12">
                            <div class="card-deck">
								<div class="card" style="width: 18rem;">
							                ...
							                <h2>
							                    <a href="{{ url('k_book/book_details') }}">
                                                    <p class="card-text d-inline" style="font-size:.8rem;">
                                                        <small class="text-white">Published: April 4, 2020  </small>
                                                        <small class="text-white"> | </small>
                                                    </p>
                                                    <p class="card-text d-inline" style="font-size:.8rem;">
                                                        <small class="text-white"> Rated: </small>
                                                        <span class="fa fa-star text-warning"></span>
                                                        <span class="fa fa-star text-warning"></span>
                                                        <span class="fa fa-star text-warning"></span>
                                                        <span class="fa fa-star text-warning"></span>
                                                    ...
                                                    <h3>
                                                        <span class="badge badge-warning">
                                                            <i class="fas fa-book"></i><small class="text-green"> 75 </small><small class="text-green"> Credits </small>
                                                        </span>
                                                    </h3>
                                                </a>
						                    </div>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title" style="font-size: 1.0rem;">The worst president in History</h5>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-m">
                                                    <img class="rounded-circle" src="{{asset('user-dash/images/users/profiles/24.jpg')}}" alt="" />
                                                </div>
                                                <div class="media-body ml-2">
                                                    <small class="text-black d-inline"> by:</small>
                                                    <h5 class="mb-0 fs-0 d-inline"> Michael</h5><br>
                                                    ...
                                                    <small class="text-muted"> Audiobook: </small><small class="text-green d-inline" style="color:#009900;"><i class="fas fa-volume-up"></i><small class="text-green"> 120 </small><small class="text-green"> Credits </small></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        <div class="card-img-top">
                                            <div class="hovereffect">
                                                ...
                                                <div class="overlay">
                                                    ...
                                                    <h3>
                                                        <span class="badge badge-warning"><i class="fas fa-book"></i><small class="text-green"> 94 </small><small class="text-green"> Credits </small></span>
                                                    </h3>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title" style="font-size: 1.0rem;">Secret Empire</h5>
                                                <div class="media align-items-center">
                                                    <div class="avatar avatar-m">
                                                    <img class="rounded-circle" src="{{asset('user-dash/images/users/profiles/14.jpg')}}" alt="" />
                                                    </div>
                                                    <div class="media-body ml-2">
                                                        <small class="text-black d-inline"> by:</small><h5 class="mb-0 fs-0 d-inline"> Lea</h5><br>
                                                        <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Politics</small><br>
                                                        <small class="text-muted"> Pages:</small><small class="text-green d-inline" style="color:#009900;"> 425</small><br>
                                                        <small class="text-muted"> Audiobook: </small><small class="text-green d-inline" style="color:#009900;"><i class="fas fa-volume-up"></i><small class="text-green"> 125 </small><small class="text-green"> Credits </small></small>
                                        ...
                                        <div class="card" style="width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title" style="font-size: 1.0rem;">Chin</h5>
                                                <div class="media align-items-center">
                                                    <div class="avatar avatar-m">
                                        ...
                                        <div class="card" style="width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title" style="font-size: 1.0rem;">Confessions of a Mafia Boss</h5>
                                                <div class="media align-items-center">
                                                    <div class="avatar avatar-m">
                            ...
                            <div class="tab-content">
                                <div class="row">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <div class="mb-1"><span class="fa fa-star text-warning fs--1"></span><span class="fa fa-star text-warning fs--1"></span><span class="fa fa-star text-warning fs--1"></span><span class="fa fa-star text-warning fs--1"></span><span class="fa fa-star text-warning fs--1"></span><span class="ml-3 text-dark font-weight-semi-bold">Awesome support, great code ðŸ˜</span>
                                        </div>
