            ...
            <div class="col-lg-3 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50">
						<a class="d-block h-50" href="k_course_details.php"><img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{asset('user-dash/k_book/book_covers/barack.jpg')}}" alt="" /></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <h5>The Worst President in History</h5>
                <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{asset('user-dash/images/users/profiles/24.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <small class="text-green"> 11 hours</small>
                    ...
                    <div class="col-sm-10">
                        <h5>Play Full Length Book</h5>
						<hr class="style12">
                        <audio src="{{asset('user-dash/k_book/book_audio/All Time.mp3')}}" controls="controls"></audio>							
                    </div>
					<div class="col mt-3">
                        <button class="btn btn-warning mr-5 mb-1" type="button">
                            <a href="{{ url('k_book/book_details_view') }}">Return to Details View</a>
                        </button>
                    </div>
                </div>
