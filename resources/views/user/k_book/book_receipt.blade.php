...
@section('title', 'Book Confirmation')
...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-center row">
        <div class="col-md-10">
            <div class="receipt bg-white p-3 rounded"><img src="{{ asset('user-dash/images/logos/K_Logo5.png') }}" width="120">
                ...
                <a  href="{{ url('k_book/book_tracking') }}">
                    <span class="fs-12 text-black-50">Track order </span>
                </a>
                <hr>
                ...
                <hr>
                <div class="d-flex justify-content-between align-items-center product-details pb-3">
                    <div class="d-flex flex-row product-name-image"><img class="rounded" src="{{asset('user-dash/k_book/book_covers/barack.jpg')}}" width="80">
                ...
                <div class="d-flex justify-content-between align-items-center product-details">
                    <div class="d-flex flex-row product-name-image"><img class="rounded" src="{{asset('user-dash/k_book/book_covers/chin.jpg')}}" width="80">
                        <div class="d-flex flex-column justify-content-between ml-2">
                ...
                <div class="d-flex justify-content-between align-items-center footer">
                    <div class="thanks"><span class="d-block font-weight-bold">Thanks for shopping</span><span>Kunnec.com</span></div>
