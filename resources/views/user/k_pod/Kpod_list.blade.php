...
@section('title', 'Kpod List')
@section('css/pod_card')
 <link href="{{ asset('user-dash/css/pod_card.css') }}" rel="stylesheet"></link>
 @endsection
@section('content')
                        ...
                        <div class="overlay">
                            ...
                            <h4>
                                <span class="badge badge-warning">
                                    ...
                                    <small class="text-green"> 75 </small>
                                    <small class="text-green"> Subscribers </small>
                                </span>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0">
                                <a class="text-dark fs-0 fs-lg-1" href="{{ url('k_pod/Kpod_channel') }}">The Worst President in History</a>
                            </h5>
                            <p class="fs--1 mb-2 mb-md-3">
                                <small class="mr-1">Created by: </small>
                                <a href="#!">
                                    <img src="{{asset('user-dash/images/users/profiles/25.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a> 
                            </p>
                            <p class="card-text d-inline" style="font-size:.8rem;">
                                <small style="color:#000000;"> Rated: </small>
                                <span class="fa fa-star text-warning"></span>
                                <span class="fa fa-star text-warning"></span>
                                <span class="fa fa-star text-warning"></span>
                                <span class="fa fa-star text-warning"></span>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                            <div class="mt-md-2">
                                <a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_pod/Kpod_channel') }}">
                                    <span class="fas fa-eye"></span>
                                    <span class="ml-2 d-none d-md-inline-block">
                                        <font style="color: #ffffff;">View Channel</font>
                                    </span>
                                </a>
                                <a class="btn btn-sm btn-success d-lg-block mt-2" href="#!">
                                    <span class="fas fa-heart"> </span>
                                    <span class="ml-2 d-none d-md-inline-block">
                                        <font style="color: #ffffff;">Add to Favorites</font>
                                    </span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p class="fs--1 mb-2 mb-md-3">
                            <small class="mr-1">Created by: </small>
                            <a href="#!">
                                <img src="{{asset('user-dash/images/users/profiles/24.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a>
                        </p>
						<p class="card-text d-inline" style="font-size:.8rem;">
                            <small style="color:#000000;"> Rated: </small>
...
<div class="col-12 p-3">
    ...
    <div class="p-1">
        <div class="row">
            <div class="col-sm-3 col-md-2" id="pod_sz">
                <div class="hovereffect">
				    <img class="img-fluid" src="{{ asset('user-dash/k_pod/images/11.jpg') }}" alt="Card image cap">
					<div class="overlay">
						<h2>
                            <a href="{{ url('k_pod/Kpod_channel') }}">
								<span class="badge badge-light">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p class="fs--1 mb-2 mb-md-3">
                            <small class="mr-1">Created by: </small>
                            <a href="#!">
                                <img src="{{asset('user-dash/images/users/profiles/23.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a>
                        </p>
						<p class="card-text d-inline" style="font-size:.8rem;">
                            <small style="color:#000000;"> Rated: </small>
                ...
                <div class="row">
                    <div class="col-lg-8">
                       ...
                       <p class="fs--1 mb-2 mb-md-3">
                           <small class="mr-1">Created by: </small>
                           <a href="#!">
                               <img src="{{asset('user-dash/images/users/profiles/13.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a>
                        </p>
						<p class="card-text d-inline" style="font-size:.8rem;">
                            <small style="color:#000000;"> Rated: </small>
...
<div class="col-12 p-3">
    ...
    <div class="p-1">
        <div class="row">
            <div class="col-sm-3 col-md-2" id="pod_sz">
                <div class="hovereffect">
				    <img class="img-fluid" src="{{ asset('user-dash/k_pod/images/18.jpg') }}" alt="Card image cap">
					<div class="overlay">
						<h2>
                            <a href="{{ url('k_pod/Kpod_channel') }}">
								<span class="badge badge-light">
                ...
                <div class="row">
                    <div class="col-lg-8">
                       ...
                       <p class="fs--1 mb-2 mb-md-3">
                           <small class="mr-1">Created by: </small>
                           <a href="#!">
                               <img src="{{asset('user-dash/images/users/profiles/8.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a>
                        </p>
						<p class="card-text d-inline" style="font-size:.8rem;">
                            <small style="color:#000000;"> Rated: </small>
...
<div class="col-12 p-3">
    ...
    <div class="p-1">
        <div class="row">
            <div class="col-sm-3 col-md-2" id="pod_sz">
                <div class="hovereffect">
				    <img class="img-fluid" src="{{ asset('user-dash/k_pod/images/14.jpg') }}" alt="Card image cap">
					<div class="overlay">
						<h2>
                            <a href="{{ url('k_pod/Kpod_channel') }}">
								<span class="badge badge-light">
                ...
                <div class="row">
                    <div class="col-lg-8">
                       ...
                       <p class="fs--1 mb-2 mb-md-3">
                           <small class="mr-1">Created by: </small>
                           <a href="#!">
                               <img src="{{asset('user-dash/images/users/profiles/17.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                            </a>
                        </p>
						<p class="card-text d-inline" style="font-size:.8rem;">
                            <small style="color:#000000;"> Rated: </small>
