...
<div class="card">
	...
	<!-- Start of Tabs -->
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="setup-tab" data-toggle="tab" href="#tab-setup" role="tab" aria-controls="tab-setup" aria-selected="true">Upload Kpod</a></li>
            <li class="nav-item"><a class="nav-link" id="team-tab" data-toggle="tab" href="#tab-team" role="tab" aria-controls="tab-team" aria-selected="true">Team</a></li>

            <li class="nav-item"><a class="nav-link" id="course-tab" data-toggle="tab" href="#tab-course" role="tab" aria-controls="tab-course" aria-selected="false">My Episodes</a></li>
		    ...
		    <li class="nav-item"><a class="nav-link" id="wish-tab" data-toggle="tab" href="#tab-wish" role="tab" aria-controls="tab-wish" aria-selected="true">Favorite Kpods</a></li>
        ...
        <div class="tab-content border-x border-bottom p-3" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-setup" role="tabpanel" aria-labelledby="setup-tab">
                    ...
                    <div class="card-body p-0">
					    ...
					    <div class="row no-gutters">
                            <div class="col-lg-8 pr-lg-2">
                                    ...
                                    <div class="card-body bg-light">
                                        <form>
                                            <div class="row">
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="heading">Kpod Channel Name</label>
                                                        <input class="form-control" id="heading" type="text">
                                                    </div>
                                                </div>
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="heading">Kpod Channel Description</label>
                                                        <input class="form-control" id="heading" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-lg-5 text-lg-right">
                                                                <label class="mb-0" for="school">Upload Channel Image</label>
                                                            </div>
                                                            <div class="col-lg-7">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-lg-5 text-lg-right">
                                                                <label class="mb-0" for="school">Upload Channel Avatar </label>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <body onload="loadImageFile();">
                                                                    <input id="upload-Image" type="file" onchange="loadImageFile();" />
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="intro">Kpod Channel Info Section</label>
                                ...
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h5 class="mb-0">Kpod Setup</h5>
                                    </div>
                                    <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center" href="#experience-form" data-toggle="collapse" aria-expanded="false" aria-controls="experience-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ml-3">Add Kpod Season</span></a>
                                        <div class="collapse" id="experience-form">
                                            <form>
                                                ...
                                                <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center" href="#education-form" data-toggle="collapse" aria-expanded="false" aria-controls="education-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ml-3">Add a Episode</span></a>
                                                    <div class="collapse" id="education-form">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-3 text-lg-right">
                                                                        <label class="mb-0" for="school">Upload  Mp3 Episode</label>
                                                                    </div>
                                                                    <div class="col-lg-7">
                                                                        <body onload="loadImageFile();">
                                                                            <input id="upload-Image" type="file" onchange="loadImageFile();" />
								                            ...
								                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-3 text-lg-right">
                                                                        <label class="mb-0" for="school">Episode Image</label>
                                                                    </div>
                                                                    <div class="col-lg-7">
                                                                        <body onload="loadImageFile();">
                                                                            <input id="upload-Image" type="file" onchange="loadImageFile();" />
							                            ...
							                            <button class="btn btn-success" type="button">Add Episode</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">Save Kpod </h5>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-primary d-block" href="{{ url('k_course/course_details_view') }}" type="button" href="#!">View Kpod </a>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-success d-block" href="#!" type="button" href="#!">Save Kpod</a>
                                    </div>
                                </div>
                                <div class="col-lg-4 pl-lg-2">
                                    <div class="sticky-top sticky-sidebar">
                                        <div class="card mb-3 overflow-hidden">
                                            <div class="card-header">
                                                <h5 class="mb-0"> Kpod Options</h5>
                                            </div>
                                            <div class="card-body bg-light">
                                                <h6 class="font-weight-bold">Kpod Avaiable for download ?<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="Will users view your Kpod for free or pay"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="pl-2">
                                                ...
                                                <h6 class="font-weight-bold">Kpod credit price <span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="Will users view your course for free or pay"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="form-group">
                                                    <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                        <option value="">each credit 20 cents...</option>
                                                        <option value="1">1 Credits</option>
                                                        <option value="2">2 Credits</option>
                                                        <option value="3">3 Credits</option>
                                                        <option value="4">4 Credits</option>
                                                        <option value="4">5 Credits</option>
                                                        <option value="4">6 Credits</option>
                                                        <option value="4">7 Credits</option>
                                                        <option value="4">8 Credits</option>
                                                        <option value="4">9 Credits</option>
                                                        <option value="4">10 Credits</option>
                                                        <option value="4">11 Credits</option>
                                                        <option value="4">12 Credits</option>
                                                        <option value="4">13 Credits</option>
                                                        <option value="4">14 Credits</option>
                                                        <option value="4">15 Credits</option>
                                                        <option value="4">16 Credits</option>
                                                        <option value="4">17 Credits</option>
                                                        <option value="4">18 Credits</option>
                                                        <option value="4">19 Credits</option>
                                                        <option value="4">20 Credits</option>
                                                    </select>
                                                </div>
					
					                            <hr class="border-dashed border-bottom-0">

                                                <h6 class="mt-2 font-weight-bold">Kpod Classification<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="This will be the level the user must be when viewing your video"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="form-group">
                                                    <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                                        <option value="">Select Kpod Rating...</option>
                                            ...
                                            <div class="card">
                                               <div class="card-body bg-light">
                                                    <div class="container">
                                                        <h5 class="fs-0">Delete this Kpod</h5>
                                                        <p class="fs--1">Once you delete this Kpod, there is no going back. Please be certain.</p><a class="btn btn-danger d-block" href="#!" type="button" href="#!" data-toggle="modal" data-target="#deleteKpodModal">Delete Kpod</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <!-- Start of Team Tab -->
                <div class="tab-pane fade" id="tab-team" role="tabpanel" aria-labelledby="team-tab">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-th-list"></i> &nbsp;Add Team Members</h5>
                                </div>
                            </div>
                            
                            <div class="card-body bg-light"><a class="mb-4 d-block d-flex align-items-center" href="#education-form" data-toggle="collapse" aria-expanded="false" aria-controls="education-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ml-3">Add a Team Member</span></a>
                                <div class="collapse" id="education-form">
                                    <form>
                                        <div class="form-group">
                                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-3 text-lg-right">
                                                    <label class="mb-0" for="school">Title</label>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input class="form-control form-control-sm" id="school" type="text" />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-3 text-lg-right">
                                                    <label class="mb-0" for="school">Upload Team Member Image</label>
                                                </div>
                                                <div class="col-lg-7">
                                                    <body onload="loadImageFile();">
                                                        <input id="upload-Image" type="file" onchange="loadImageFile();" />
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="intro">Team Member About Section</label>
                                                <textarea class="form-control" id="intro" name="intro" cols="30" rows="13"></textarea>
                                            </div>
                                        </div>
								    </form>
                                    <hr class="border-dashed border-bottom-0 my-4" />
							            <button class="btn btn-success" type="button">Add Team Member</button>
                                </div>
                            </div>
                                ...
                                <table class="table table-hover">
                                    <thead style="color:#FFFFFF; background-color:#009900;">
                                        <tr>
                                            ...
                                            <th scope="col">Name <i class="fas fa-sort-alpha-up"></i></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>
                                                <a href="{{ url('k_course/course_details') }}"><img src="{{ asset('user-dash/k_course/courses/sun.jpg') }}" width="75px">
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ url('k_course/course_details') }}">The Direction is Always Up
                                                </a>
                                            </td>
                                            <td>
                                                <a href="k_course_edit.php"><i class="fas fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
                ...
                <!-- Start of My Episodes Tab -->
                <div class="tab-pane fade" id="tab-course" role="tabpanel" aria-labelledby="course-tab">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-th-list"></i> &nbsp;My Episodes</h5>
                                </div>
                            </div>
                            <div class="table-responsive-sm">
                                <table class="table table-hover">
