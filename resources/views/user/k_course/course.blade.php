    ...
    <div class="row">
        <div class="col-sm mt-2">
            <p>
                ...
                <a href="{{ url('k_course/course_settings') }}" style="font-size:20px; color: #ffffff;">
...
<div class="card">
  <div class="card-body">
       <p class=" text-center" style="color: #009900"><strong>Top Rated Courses</p></div>  
    <div class="card-deck">
        <div class="card">
            <div class="card-img-top">
                <span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated</span>
            </div>
            <img class="img-fluid" src="{{ asset('user-dash/k_course/courses/2.jpg') }}" alt="Card image cap">
            <div class="card-body">
                <h6 class="fs-9">
                    <strong><a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp</a>
                    </strong>
                </h6>
                ...
                <p class="fs--1 mb-1"><span class="badge badge-warning" >75 </span> Credits</p>
            </div>
		    <div class="d-flex align-items-center justify-content-between px-3">
                <div>
                    <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1">(18)</span>
                </div>
                <div>
                    <a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Wish List"><span class="far fa-heart"></span>
                    </a>
			    </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-img-top">
                <span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Top Rated
                </span>
            </div>
            <img class="img-fluid" src="{{ asset('user-dash/k_course/courses/1.jpg') }}" alt="Card image cap">
            <div class="card-body">
                <h6 class="fs-9">
                    <strong><a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a>
                    </strong>
                </h6>
                <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
                <div class="media align-items-center">
                ...
                <p class="fs--1 mb-1"><span class="badge badge-warning" >125 </span> Credits
                </p>
            </div>
            <div class="d-flex align-items-center justify-content-between px-3">
                <div>
                    <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1">(20)</span>
                </div>
                <div>
                    <a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Wish List"><span class="far fa-heart"></span>
                    </a>
        ...
        <div class="card">
            ...
            <img class="img-fluid" src="{{ asset('user-dash/k_course/courses/5.jpg') }}" alt="Card image cap">
            <div class="card-body">
            <h6 class="fs-9">
                <strong>
                    <a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp
                    </a>
                </strong>
            </h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            ...
            <p class="fs--1 mb-1"><span class="badge badge-warning" >65 </span> Credits</p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
   ...
   <div class="card">
        ...
        <img class="img-fluid" src="{{ asset('user-dash/k_course/courses/6.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9">
                <strong>
                    <a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Photoshop CS4 training
                    </a>
                </strong>
            </h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            ...
            <p class="fs--1 mb-1"><span class="badge badge-warning" >46 </span> Credits</p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
            <div>
                <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1">(29)</span>
            </div>
            <div>
                <a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Wish List"><span class="far fa-heart"></span>
                </a>
...
<div>
    <p class=" text-center" style="color: #FFFFFF"><strong>Top Rated Courses</p>
</div>  
<div>
    <p class=" text-center" style="color: #009900"><strong>Trending Courses</p>
</div>  

<div class="card-deck">
    <div class="card">
        <div class="card-img-top">
            <span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span>
        </div>
        <img class="img-fluid" src="{{ asset('user-dash/k_course/courses/shirt.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9">
                <strong>
                    <a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Learning photoshop the easy way. CSS/ Mamp
            ...
            <p class="fs--1 mb-1"><span class="badge badge-warning" >96 </span> Credits</p>
        </div>
		<div class="d-flex align-items-center justify-content-between px-3">
            <div>
                <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1">(18)</span>
	...
	<div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('user-dash/k_course/courses/9.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="k_course_details.php" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
                    <img class="rounded-circle" src="{{asset('user-dash/images/users/profiles/14.jpg')}}" alt="" />
                </div>
                <div class="media-body ml-2">
                    <h5 class="mb-0 fs-0">Sabrina</h5>
                </div>
			</div>
            <p class="fs--1 mb-1"><span class="badge badge-warning" >125 </span> Credits</p></div>
		<div class="d-flex align-items-center justify-content-between px-3">
    ...
    <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('user-dash/k_course/courses/4.jpg') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
			    <div class="avatar avatar-m">
   ...
   <div class="card">
        <div class="card-img-top"><span class="badge badge-pill badge-warning position-absolute r-0 t-0 mt-2 mr-2 z-index-2">Trending</span></div><img class="img-fluid" src="{{ asset('user-dash/k_course/courses/14.png') }}" alt="Card image cap">
        <div class="card-body">
            <h6 class="fs-9"><strong><a href="{{ url('k_course/course_details') }}" style="font-size: 1.0rem; color: #009900;">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz </a></strong></h6>
            <p class="fs--1 mb-3"><a class="text-500" href="#!">Excel &amp; Access</a></p>
            <div class="media align-items-center">
            ...
            <p class="fs--1 mb-1"><span class="badge badge-warning" >46 </span> Credits</p></div>
		<div class="d-flex align-items-center justify-content-between px-3">
            <div><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="ml-1">(20)</span>
            </div>
            <div><a class="btn btn-sm btn-falcon-default mr-2" href="#!" data-toggle="tooltip" data-placement="top" title="Add to Wish List"><span class="far fa-heart"></span></a>
