            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    <div class="position-relative h-sm-50">
                        <img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('user-dash/k_course/courses/5.jpg') }}" alt="" />
                    </div>
                </div>
                  
                </div>
                    <div class="col-lg-6">
                        <button class="btn btn-lg btn-success rounded-capsule mr-1 mb-1" type="button" href="#!" data-toggle="modal" data-target="#courseModal"><span class="fas fa-donate"></span> Purchase </a>
                        </button>
				        ...
				        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{asset('user-dash/images/users/profiles/5.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
                        ...
                        <p class="fs--1" style="color: #000000"><strong><u>Requirements</u></strong>
                        </p>
				        <ul style="list-style-type:none;">
                            <li>You should have a basic understanding of SQL.</li>
                            <li>You must understand Unix/Linux Commands.</li>
                            <li>Understanding Database Architecture.</li>
                        </ul>
				        <p class="fs--1 mb-1"> <span>Language: </span><strong>English</strong>
                        </p>
                        <div class="row">
                        ...
                        <div class="fancy-tab overflow-hidden mt-4">
                            ...
                            <div class="tab-contents">
                                ...
                                <div class="tab-content">
					                <div class="nav-bar-item active pl-0 pr-2 pr-sm-4">
                                        <div class="mt-1 fs--1"><strong>Course Overview</strong></div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <h2 class="mb-0">
                                                    ...
                                                    <span class="fas fa-plus mr-1" data-fa-transform="shrink-3"></span> Introduction  ( 37:15 ) - 3 Videos
                                                    </button>
                                                </h2>
                                            </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><button class="btn btn-success" type="button" data-toggle="modal" data-target="#previewModal">Preview</button></td>
                                                                        <td>02:47</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th scope="row">2</th>
                                            ...
                                            <div class="card-header" id="headingThree">
                                                <h2 class="mb-0">
                                                    <button class="btn btn-success w-100" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <span class="fas fa-plus mr-1" data-fa-transform="shrink-3"></span> Process Architecture  ( 47:42 ) - 4 Videos
                                                    </button>
                                                </h2>
                                            </div>
                                    ...
                                    <div class="col-lg-12 pr-lg-2">
                                        <p class=" text-center" style="color: #FF8C00">Watch Course and return to this page to rate and review.</p>
                                    </div>
