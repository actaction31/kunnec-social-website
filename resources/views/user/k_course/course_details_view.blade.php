@extends('layouts.user')
 @section('title', 'Course Details View')
        ...
        <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-slider position-relative">
                    ...
                    <div class="col-lg-6">
                        <a href="{{ url('k_course/course_settings') }}">
                            <button class="btn btn-lg btn-primary rounded-capsule mr-1 mb-1" type="button"  ><span class="fas fa-donate"></span> Return to Course Setup 
                        </button>    
                        </a>
