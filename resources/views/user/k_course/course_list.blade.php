...
<div class="card mb-3">
   <div class="card-body p-0 overflow-hidden">
                    ...
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="position-relative h-sm-50">
                                <a class="d-block h-50" href="{{ url('k_course/course_details') }}">
                                    <img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('user-dash/k_course/courses/2.jpg') }}" alt="" />
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <h5 class="mt-3 mt-sm-0">
                                        <a class="text-dark fs-0 fs-lg-1" href="{{ url('k_course/course_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA
                                        </a>
                                    </h5>
                                    <p class="fs--1 mb-2 mb-md-3">
                                        <small class="mr-1">Created by: </small>
                                        <img src="{{asset('user-dash/images/users/profiles/22.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
                                    </p>
                                    <ul class="list-unstyled d-none d-lg-block">
                                        <li><span><font style="color: #3f3f3f;">12 parts</font></span> / <span><font style="color: #3f3f3f;">22 Hours</font></span>
                                        </li>
                                        <li><span>Learn to become an Oracle Database Administrator ( DBA ) in 6 weeks and get paid job as a junior DBA.</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-4 d-flex justify-content-between flex-column">
                                    ...
                                    <div class="mt-md-2">
                                        <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Add to Wish List</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_course/course_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">View Details</font></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="p-1">
                    <div class="row">
                            ...
                            <div class="position-relative h-sm-100">
                                 <div class="owl-carousel owl-theme h-100 position-relative" data-options='{"items":1,"nav":true,"autoplay":true,"dots":false,"loop":true}'>
                                    <div class="item h-100">
                                        <a class="d-block h-sm-100" href="{{ url('k_course/course_details') }}"><img class="rounded h-100 w-100 fit-cover" src="{{ asset('user-dash/k_course/courses/4.jpg') }}" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-7 col-md-8">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_course/course_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                    <p class="fs--1 mb-2 mb-md-3">
                                        <small class="mr-1">Created by: </small><img src="{{asset('user-dash/images/users/profiles/15.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Tony
                                    </p>
                                    <ul class="list-unstyled d-none d-lg-block">
                                        <li><span><font style="color: #3f3f3f;">12 parts</font></span> / <span><font style="color: #3f3f3f;">22 Hours</font></span>
                                        </li>
                                ...
                                <div class="col-lg-4 d-flex justify-content-between flex-column">
                                    ...
                                    <div class="mt-md-2">
                                        <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Add to Wish List</span>
                                        </a>
                                        <a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_course/course_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">View Details</font></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12 p-3">
                <div class="p-1">
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="position-relative h-sm-100">
                                <a class="d-block h-100" href="{{ url('k_course/course_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('user-dash/k_course/courses/3.jpg') }}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="col-sm-7 col-md-8">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="fs--1 mb-2 mb-md-3">
                                        <small class="mr-1">Created by: </small><img src="{{asset('user-dash/images/users/profiles/11.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Shaheed
                                    </p>
                                    <ul class="list-unstyled d-none d-lg-block">
                                        <li>
                                            <span><font style="color: #3f3f3f;">12 parts</font></span> / <span><font style="color: #3f3f3f;">22 Hours</font></span>
                                        </li>
                                        <li>
                                ...
                                <div class="col-lg-4 d-flex justify-content-between flex-column">
                                    <div>
                                        <h4 class="fs-1 fs-md-2 text-warning mb-0">75 credits
                                        </h4>
                                        <div class="mb-2 mt-3">
                                            <span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="ml-1">(8)
                                            </span>
                                        </div>
                                    </div>
                                    <div class="mt-md-2">
                ...
                <div class="col-12 p-3 bg-100">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-5 col-md-4">
                                <div class="position-relative h-sm-100">
                                    <a class="d-block h-100" href="{{ url('k_course/course_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('user-dash/k_course/courses/6.jpg') }}" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-sm-7 col-md-8">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="fs--1 mb-2 mb-md-3">
                                            <small class="mr-1">Created by: </small><img src="{{asset('user-dash/images/users/profiles/5.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Michael
                                        </p>
                                        <ul class="list-unstyled d-none d-lg-block">
                                            <li><span><font style="color: #3f3f3f;">12 parts</font></span> / <span><font style="color: #3f3f3f;">22 Hours</font></span>
                                            </li>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="mt-md-2">
                                            <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Add to Wish List</span></a>
                                            <a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_course/course_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">View Details</font></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card-footer border-top d-flex justify-content-center">
            <div>
                <button class="btn btn-success" type="button" >Load More</a>
            </div>
        </div>
    </div>
</div>
