@extends('layouts.user')
 @section('title', 'To Me Notifications')
...
@section('content')
  ...
  <div class="card p-2" style=" background-color: #009900;">
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <h5 class="title" style="color:#ffffff;"><i class="far fa-bell"></i> Kunnec to Me</h5>
        <div class="row">
            <div class="col">
...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="border-bottom border-gray pb-2 mb-0">Kunnec To Me Posts</h6>
    <div class="media text-muted pt-3">
        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            ...
            <span class="d-block"> I am looking for a painter to help me paint my house!</span>
        </div>
    </div>
    ...
    <div class="media text-muted pt-3">
        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            ...
            <span class="d-block">Help wanted to fix my computer program.</span>
        </div>
    </div>
    ...
    <div class="media text-muted pt-3">
        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            ...
            <span class="d-block">Looking to hire a new assistant.</span>
        </div>
    </div>
