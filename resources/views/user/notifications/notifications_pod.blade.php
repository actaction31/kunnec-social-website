@extends('layouts.user')
 @section('title', 'Pod Notifications')
...
@section('content')
  ...
  <div class="card p-2" style=" background-color: #009900;">
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <h5 class="title" style="color:#ffffff;"><i class="far fa-bell"></i> Kunnec Pod</h5>
        <div class="row">
            <div class="col">
...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="border-bottom border-gray pb-2 mb-0">Kunnec Pods</h6>
    <div class="media text-muted pt-3">
        ...
        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            ...
            <div class="alert alert-warning" alert-dismissible fade show role="alert">
                <strong>New Pod</strong> - Episode 24
            </div>
        </div>
    </div>
