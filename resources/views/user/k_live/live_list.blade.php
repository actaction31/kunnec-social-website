@extends('layouts.user')
 @section('title', 'Kunnec Show List')
    ...
    <div class="card-body">
        <div class="row justify-content-between align-items-center">
            <div class="col-sm-auto mb-2 mb-sm-0">
                <h6 class="mb-0">Showing 1-24 of 205 Entertainment</h6>
            </div>
                ...
                <div class="p-1">
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="position-relative h-sm-50"><a class="d-block h-50" href="{{ url('k_live/live_details') }}"><img class="img-fluid fit-cover w-sm-50 h-sm-50 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_live/7.jpg') }}" alt="" /></a>
                            </div>
                        </div>
						<div class="col-sm-7 col-md-8">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_live/live_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                                    <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> </small><img src="{{ asset('public/user-dash/images/users/profiles/4.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p>
						        ...
						        <div class="mt-md-2"><a class="btn btn-sm btn-outline-secondary border-300 d-lg-block mt-2 mr-2 mr-lg-0" href="#!"><span class="far fa-heart"></span><span class="ml-2 d-none d-md-inline-block">Save Show</span></a><a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_live/live_details') }}"><span class="fas fa-eye"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Show Details</font></span></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-1">
                <div class="row">
                    <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100">
                            <div class="item h-100"><a class="d-block h-sm-100" href="{{ url('k_live/live_details') }}"><img class="rounded h-100 w-100 fit-cover" src="{{ asset('public/user-dash/k_live/9.jpg') }}" alt="" /></a></div>
                            </div>
                        </div>
                    <div class="col-sm-7 col-md-8">
                        <div class="row">
                            <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_live/live_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                            <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"></small><img src="{{ asset('public/user-dash/images/users/profiles/5.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Tony</p>
                            <ul class="list-unstyled d-none d-lg-block">
                             <li><span><font style="color: #3f3f3f;">Schedule:</font></span>  <span><font style="color: #3f3f3f;">M ( 7 - 9 am ), T ( 2 - 6 pm ), W ( 4 - 6 am ) </font></span></li>
                ...
                <div class="col-12 p-3">
                  <div class="p-1">
                    <div class="row">
                      <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100"><a class="d-block h-100" href="{{ url('k_live/live_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_live/6.jpg') }}" alt="" /></a>
                        </div>
                      </div>
                      <div class="col-sm-7 col-md-8">
                        <div class="row">
                          <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_live/live_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                            <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Recorder: </small><img src="{{ asset('public/user-dash/images/users/profiles/6.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Shaheed</p>
                            <ul class="list-unstyled d-none d-lg-block">
                ...
                <div class="col-12 p-3 bg-100">
                  <div class="p-1">
                    <div class="row">
                      <div class="col-sm-5 col-md-4">
                        <div class="position-relative h-sm-100"><a class="d-block h-100" href="{{ url('k_live/live_details') }}"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded absolute-sm-centered" src="{{ asset('public/user-dash/k_live/11.jpg') }}" alt="" /></a>
                        </div>
                      </div>
                      <div class="col-sm-7 col-md-8">
                        <div class="row">
                          <div class="col-lg-8">
                            <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_live/live_details') }}">Oracle DBA 11g/12c - Database Administration for Junior DBA</a></h5>
                            <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"></small><img src="{{ asset('public/user-dash/images/users/profiles/7.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Michael</p>
                            <ul class="list-unstyled d-none d-lg-block">
