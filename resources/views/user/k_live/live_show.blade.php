...
<div id="wrapper">
    <nav class="navbar navbar-expand-lg navbar-custom rounded" style="background-color: #009900;">
        <div class="container-fluid">
            ...
            <h3 class="card-title mt-2 ml-3"><img src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image"><font color="#FFFFFF" style="font-size:18px"> {{Auth::user()->username}} Show</font></h3>
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <button class="btn btn-danger btn-sm mt-2" type="button" href="#!" data-toggle="modal" data-target="#show_roomModal" id="">
                                        Exit Show
                                    </button>
    ...
    <div class="card ml-2 mr-2 mb-3 pl-3 pt-3 pb-3 pr-3">
        <div class="row">
            ...
            <div class="col-sm-4">
                <div id="mydivheader">
                        <img src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">  {{Auth::user()->username}} | Vistor Chat
                </div>
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 550px; padding-top: 10px;">
                    <div class="chat-list-wrapper" style="overflow-y: auto; width: auto; height: 550px;">
                        <ul class="chat-list" style="list-style: none;">
                            <li>
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/25.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
                            ...
                            <li class="active">
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/24.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
                            ...
                            <li>
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/18.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
                            ...
                            <li>
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/14.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
                            ...
                            <li>
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/22.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
                            ...
                            <li>
                                <span>
                                <img src="{{ asset('public/user-dash/images/users/profiles/17.jpg')}}" width="30px" height="30px" class="rounded-circle img-border box-shadow-1" alt="Card image">
                                </span>
                                <div class="body">
                                    <div class="header">
