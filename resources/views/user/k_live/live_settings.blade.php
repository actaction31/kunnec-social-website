...
<div class="card">
	...
	<!-- Start of Tabs -->
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="setup-tab" data-toggle="tab" href="#tab-setup" role="tab" aria-controls="tab-setup" aria-selected="true">Show Setup</a></li>
            <li class="nav-item"><a class="nav-link" id="course-tab" data-toggle="tab" href="#tab-course" role="tab" aria-controls="tab-course" aria-selected="false">My Shows</a></li>
            <li class="nav-item"><a class="nav-link" id="purchase-tab" data-toggle="tab" href="#tab-purchase" role="tab" aria-controls="tab-purchase" aria-selected="true">Purchased Shows</a></li>
					    ...
					    <div class="row no-gutters">
                            <div class="col-lg-8 pr-lg-2">
                                    ...
                                    <div class="card-body bg-light">
                                        <form>
                                            <div class="row">
					                            <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="heading">Title of Shows</label>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-0">Save Show</h5>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-primary d-block" href="{{ url('k_live/live_details_view') }}" type="button" href="#!">View Show</a>
                                    </div>
                                    <div class="card-body bg-light"><a class="btn btn-success d-block" href="#!" type="button" href="#!">Save Show</a>
                                    </div>
                                </div>
                                <div class="col-lg-4 pl-lg-2">
                                    <div class="sticky-top sticky-sidebar">
                                        <div class="card mb-3 overflow-hidden">
                                            ...
                                            <div class="card-body bg-light">
                                                <h6 class="font-weight-bold">Will this show be free ?<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="Will users view your course for free or pay"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="pl-2">
                                                ...
                                                <h6 class="mt-2 font-weight-bold">Show Level<span class="fs--2 ml-1 text-success" data-toggle="tooltip" data-placement="top" title="This will be the level you want the user to be when viewing course"><span class="fas fa-question-circle"></span></span></h6>
                                                <div class="form-group">
                                                    <select class="custom-select" id="card-holder-country" name="customSelectCountry" required="required">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="mb-0">Show Cover Video Image</h5>
                                                </div>
                                                <div class="card-body bg-light">
                                                    <div class="container">
                                                        <div class="col-md-6">
                                                    ...
                                                    <h5 class="fs-0">Delete this Show</h5>
                                                    <p class="fs--1">Once you delete this show, there is no going back. Please be certain.</p><a class="btn btn-danger d-block" href="#!" type="button" href="#!" data-toggle="modal" data-target="#deleteCourseModal">Delete Show</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-th-list"></i> &nbsp;My Shows</h5>
                                </div>
                            </div>
                            <div class="table-responsive-sm">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/sun.jpg') }}" width="75px"></a></td>
                                            <td><a href="{{ url('k_live/live_details') }}">The Direction is Always Up</a></td>
                                            ...
                                            <td><a href="k_live_edit.php"><i class="fas fa-edit"></i></a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/clouds.jpg') }}" width="75px"></a></td>
                                            <td><a href="{{ url('k_live/live_details') }}">The Sun Always shines</a></td>
                                        ...
                                        <tr>
                                            <th scope="row">3</th>
                                            <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/hands.jpg') }}" width="75px"></a></td>
                                            <td><a href="{{ url('k_live/live_details') }}">Two Can Keep A Secret if One is Dead</a></td>
                                        ...
                                        <tr>
                                            <th scope="row">4</th>
                                            <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/tree.jpg') }}" width="75px"></a></td>
                                            <td><a href="{{ url('k_live/live_details') }}">Always win at all cost, never fall</a></td>
                                        ...
                                        <tr>
                                            <th scope="row">5</th>
                                            <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/ocean.jpg') }}" width="75px"></a></td>
                                            <td><a href="{{ url('k_live/live_details') }}">There is a I in win</a></td>
                ...
                <div class="tab-pane fade" id="tab-purchase" role="tabpanel" aria-labelledby="purchase-tab">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-4 col-sm-auto d-flex align-items-center pr-0 mb-3">
                                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-dollar-sign"></i> &nbsp; Show Purchased</h5>
                                </div>
                            </div>
                            <div class="table-responsive-sm">
                                <table class="table table-hover">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>02/21/1988</td>
                                        <td><span class="badge badge-pill badge-warning">75</span></td>
                                        <td><a href="{{ url('k_live/live_details') }}"><span class="badge badge-pill badge-success">PURCHASE</span></a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td><a href="{{ url('k_live/live_details') }}"><img src="{{ asset('public/user-dash/k_live/images/clouds.jpg') }}" width="75px"></a></td>
...
<script  type="text/javascript" src="{{ asset('public/user-dash/js/imgprv.js') }}"></script>
@endsection