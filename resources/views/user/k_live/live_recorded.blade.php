...
<div class="card mb-3 mt-3 mt-lg-0">
    <div class="container">
        ...
        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1">Created by: </small><img src="{{ asset('public/user-dash/images/users/profiles/5.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina
        </p>
                
		<div class="d-flex justify-content-center">
			<div class="p-2">
				<video controls autoplay>
                    <source src="{{ asset('public/user-dash/k_course/videos/mad.mp4')}}" type="video/mp4">Your browser does not support the video tag.
					</source>
                </video>
			</div>
        </div>
