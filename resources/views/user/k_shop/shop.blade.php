...
<div class="col-lg-12 rounded mb-2" style="background-color:#009900;">
    <div class="row">
		<div class="col-sm mt-2">
            <p>
                <a href="{{ url('k_shop/shop') }}" style="color: #FFFFFF"><img src="{{ asset('images/K_Logo6.png') }}" height="40px" width="60px"/> Kunnec Shop</a>|&nbsp;
                ...
                <div class="card-body">
                    ...
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ml-2">
                            ...
                            <h5 class="mb-0 fs-0 d-inline"> Michael</h5>
                            <br>
                            <small class="text-muted"> Category:</small>
                            <small class="text-green d-inline" style="color:#009900;">Kitchen</small>
                            <br>
                            <small class="text-muted"> Price:</small><small class="text-green d-inline" style="color:#009900;">$ 75.00 </small>
                            <br>
				    ...
				    <div class="hovereffect">
						...
						<div class="overlay">
                             <a href="{{ url('k_shop/shop_details') }}">
								...
								<h3><span class="badge badge-warning"><i class="fas fa-money-bill" aria-hidden="true"></i><small class="text-green"> $ 75.00 </small><small class="text-green"> </small></span></h3>
                            </a>
						</div>
                    </div>
				</div>	
				    ...
				    <div class="hovereffect">
						...
						<div class="overlay">
                            <a href="{{ url('k_shop/shop_details') }}">
								...
								<h3><span class="badge badge-warning"><i class="fas fa-money-bill" aria-hidden="true">
                                    </i><small class="text-green"> $ 75.00 </small><small class="text-green"> </small></span>
                                </h3>
                            </a>
						</div>
                    </div>
