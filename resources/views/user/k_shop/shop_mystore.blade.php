...
<div class="card-body">
    <h5 class="card-title">My Store</h5>
    <div class="card-deck">
				...
				<div class="hovereffect">
					...
					<div class="overlay">
                        <a href="{{ url('k_shop/shop_details') }}">
						    <h2>
							    <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Added: April 4, 2020  </small><small class="text-white"> | </small>
                                </p>
							...
							<h3><span class="badge badge-warning"><i class="fas fa-money-bill" aria-hidden="true"></i><small class="text-green"> $ 75.00 </small><small class="text-green"> </small></span>
                            </h3>
                        </a>
					</div>
                </div>
