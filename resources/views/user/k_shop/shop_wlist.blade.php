...
<div class="card">
    <div class="card-body">
         <div class="col-12 p-3">
		    <h5 class="mt-3 mt-sm-0"> {{Auth::user()->username}} Wish List</h5>
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
				               ...
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/2.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										   ...
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Apple Desktop</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="{{ url('profile') }}"><img src="{{asset('user-dash/images/users/profiles/14.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        <div class="mt-md-2">
                                            <a class="btn btn-sm btn-success d-lg-block mt-2" href="{{ url('k_shop/shop_cart') }}"><span class="fas fa-shopping-cart"></span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Add to Cart</font></span></a>
                                            <a class="btn btn-sm btn-success d-lg-block mt-2" href="#!"><span class="fas fa-ban"> </span><span class="ml-2 d-none d-md-inline-block"><font style="color: #ffffff;">Remove</font></span></a>
									    </div>
                                    </div>
                                </div>
                    ...
                    <div class="p-1">
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Refurbished Laptop 17"</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/14.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/7.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_shop/shop_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Digital Camera Polaroid</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/12.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/4.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_shop/shop_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Adjusting Camera Lens</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/sabrina.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
                    ...
                    <div class="p-1">
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Nikon Digital Sway Camera</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/22.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/pants3.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_shop/shop_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Bluetooth Grinder Mouse</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/16.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/8.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_shop/shop_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Digital Smart Watch</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/9.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
				...
				<hr class="style12">
                    <div class="p-1">
                        <div class="row">
                            <div class="col-sm-3 col-md-2">
                                <div class="hovereffect">
				               <img class="img-fluid" src="{{ asset('user-dash/k_shop/products/6.jpg') }}" alt="Card image cap">
								    <div class="overlay">
									    <h2>
										    <a href="{{ url('k_shop/shop_details') }}">
										   <p class="card-text d-inline" style="font-size:.8rem;"><small class="text-white">Uploaded: April 4, 2020  </small><small class="text-white"> | </small></p>
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Samsung 14" Tablet</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/19.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
                    ...
                    <div class="p-1">
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="{{ url('k_shop/shop_details') }}">Apple I-Phone 8x</a></h5>
                                        <p class="fs--1 mb-2 mb-md-3"><small class="mr-1"> by: </small><a href="k_shop_details.php"><img src="{{asset('user-dash/images/users/profiles/13.jpg')}}" width="25px" height="25px" class="rounded-circle img-border box-shadow-1" alt="Card image"> Sabrina</p></a>
									       <small class="text-muted"> Category:</small><small class="text-green d-inline" style="color:#009900;"> Electronics</small><br>
									       <h4><span class="badge alert-success p-2">Price |&nbsp;&nbsp; <span class="badge badge-light">$75.00</span></span></h4><hr class="style12">
										   <small class="text-black d-inline">Description</small><br>
										   <ul class="list-unstyled d-none d-lg-block">
