...
<div class="card p-2" style=" background-color: #009900;">
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <h5 class="title" style="color:#ffffff;"><i class="far fa-comments"></i> Kunnec Messages</h5>
        <!--
        <div class="row">
            <div class="col">
                <div class="d-inline pb-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        ...
                        <button class="dropdown-item" type="button"> 
                            <a href="{{ url('messages/message_vid') }}" style="font-size:12px;"> 
