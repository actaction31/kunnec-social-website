      ...
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="navbar-right">
              <a href="{{ route('admin.jobCats.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Add New</a>
          </div>
...
<script>
  $(document).ready(function(){
    $('.searchInput').on('keyup', function(){
      ...
      $.ajax({
        url : "{{ route('admin.jobCats.search') }}"+search_key,
        method: 'GET',
      }).done(function (data){
        out_put.html(data);
      }).fail(function () {
