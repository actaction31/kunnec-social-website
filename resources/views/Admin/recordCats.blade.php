...
@section('content')
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Recorder Category</h2>
          <div class="navbar-right">
              <a href="{{ route('admin.recordCats.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Add New</a>
          </div>
...
<script>
  $(document).ready(function(){
    $('.searchInput').on('keyup', function(){
      ...
      $.ajax({
        url : "{{ route('admin.recordCats.search') }}"+search_key,
        method: 'GET',
      }).done(function (data){
        out_put.html(data);
      }).fail(function () {
