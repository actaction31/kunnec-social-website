...
@section('additional-css')
    ...
    <link href="{{ asset('public/libs/bootstrap-datepicker/gijgo.min.css') }}" rel="stylesheet">
@endsection
@section('content')
<!-- Start Signup Page -->
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="signup-form" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                             <div class="col-md-6 mb-2">
                                 <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" required autocomplete="new-password" required id="signup-password-field">
                                 <span toggle="#signup-password-field" class="fa fa-fw fa-eye field-icon toggle-password" style="top: 12px;"></span>
                                 @error('password')
                                     <span class="invalid-feedback d-block" role="alert">
                                         <strong>{{ $message }}</strong>
                                     </span>
                             ...
                             <div class="col-md-6">
                                 ...
                                 <span toggle="#password-confirm" class="fa fa-fw fa-eye field-icon toggle-password" style="top: 12px;"></span>
                             </div>
                         </div>

                        <div class="form-group row">
                            <div class="col-md-6 mb-2">
                                <input class="date form-control" name="dob" placeholder="Date of Birth" id="dob" type="text" required readonly="" value="{{ old('dob') }}">
                                @error('dob')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <hr class="style12">
                        <h5>Security Questions for blocked account from incorrect email/password combination:</h5>
                        <div class="form-group row">
                                ...
                                <select class="form-control" name="ques1" id="ques1" required>
                                    ...
                                    @if($securityQuestions)
                                        @foreach($securityQuestions as $Question)
                                            <option @if($Question==old('ques1')) selected @endif>{{ $Question }}</option>
                                        @endforeach
                                    @endif  
                                </select>
                                @error('ques1')
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 mb-2">
                                <select class="form-control" name="ques2" id="ques2" required>
                                    ...
                                    @if($securityQuestions)
                                        @foreach($securityQuestions as $Question)
                                            <option @if($Question==old('ques2')) selected @endif>{{ $Question }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('ques2')
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 mb-2">
                                <select class="form-control" name="ques3" id="ques3" required>
                                    ...
                                    @if($securityQuestions)
                                        @foreach($securityQuestions as $Question)
                                            <option @if($Question==old('ques3')) selected @endif>{{ $Question }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('ques3')
                        ...
                        <hr class="style12">
                        <h5>Select Your Plan ( <font style="color:#FF0000;"> Free to join our community.</font> )</h5>
                            ...
                            @foreach($plans as $plan)
                                <div class="col-md-6 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="plan" id="normal-plan_{{$plan->id}}" value="{{$plan->id}}">
                                        <label class="form-check-label" for="normal-plan_{{$plan->id}}">${{$plan->amount}} per {{$plan->type}}.</label>
                                    </div>
                                </div>
                            @endforeach
                            @endif
...
<script src="{{ asset('public/libs/bootstrap-datepicker/gijgo.min.js') }}"></script>
<script>
    var getStatesUrl = "{{ route('register') }}"+"/states/";
    var getCitiesUrl = "{{ route('register') }}"+"/cities/";
    ...
    var oldDOB = "{{old('dob')}}"
    var chkUsername="{{ route('check.username') }}";
</script>
